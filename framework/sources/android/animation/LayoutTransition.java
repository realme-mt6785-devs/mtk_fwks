...
public class LayoutTransition {
    ...
    public LayoutTransition() {
        ...
        if (defaultChangeIn == null) {
            ...
            ObjectAnimator clone = defaultChangeIn.clone();
            defaultChangeOut = clone;
            ...
            ObjectAnimator clone2 = defaultChangeIn.clone();
            defaultChange = clone2;
            clone2.setStartDelay(this.mChangingDelay);
