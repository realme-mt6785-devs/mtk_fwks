...
public class AlarmManager {
    ...
    public void setTime(long millis) {
        Log.d(TAG, "setTime millis=" + millis);
        printStackTraceInfo();
        try {
            Log.d(TAG, "inside setTime minWest = " + millis, new RuntimeException().fillInStackTrace());
    ...
    public void setTimeZone(String timeZone) {
        Log.d(TAG, "inside setTimeZOne timeZ = " + timeZone, new RuntimeException().fillInStackTrace());
        if (!TextUtils.isEmpty(timeZone)) {
            ...
            Log.d(TAG, "setTimeZone timeZone=" + timeZone);
            printStackTraceInfo();
            try {
    ...
    private void printStackTraceInfo() {
        ...
        for (StackTraceElement element : stack) {
            Log.d(TAG, "AlarmManager    |----" + element.toString());
        }
    }
}
