...
public abstract class AppOpsManagerInternal {
    ...
    public interface CheckOpsDelegate {
        ...
        void finishProxyOperation(int i, AttributionSource attributionSource, boolean z, TriFunction<Integer, AttributionSource, Boolean, Void> triFunction);
        ...
        SyncNotedAppOp startProxyOperation(int i, AttributionSource attributionSource, boolean z, boolean z2, String str, boolean z3, boolean z4, int i2, int i3, int i4, DecFunction<Integer, AttributionSource, Boolean, Boolean, String, Boolean, Boolean, Integer, Integer, Integer, SyncNotedAppOp> decFunction);
