...
public class ApplicationPackageManager extends PackageManager {
    ...
    public IApplicationPackageManagerExt mApplicationPackageManagerExt;
    ...
    public PackageInfo getPackageInfo(String packageName, int flags) throws PackageManager.NameNotFoundException {
        PackageInfo pi = getPackageInfoAsUser(packageName, flags, getUserId());
        this.mApplicationPackageManagerExt.checkAndLogMultiApp(pi == null, this.mContext, packageName, "getPackageInfo");
        return pi;
    }
    ...
    public boolean arePermissionsIndividuallyControlled() {
        if (this.mApplicationPackageManagerExt.arePermissionsIndividuallyControlledOverrideTrue()) {
            return true;
        }
    ...
    public ActivityInfo getActivityInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            this.mApplicationPackageManagerExt.checkAndLogMultiApp(true, this.mContext, className, "getActivityInfo");
    ...
    public ActivityInfo getReceiverInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            this.mApplicationPackageManagerExt.checkAndLogMultiApp(true, this.mContext, className, "getReceiverInfo");
            throw new PackageManager.NameNotFoundException(className.toString());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public ServiceInfo getServiceInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            this.mApplicationPackageManagerExt.checkAndLogMultiApp(true, this.mContext, className, "getServiceInfo");
            throw new PackageManager.NameNotFoundException(className.toString());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public ProviderInfo getProviderInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            this.mApplicationPackageManagerExt.checkAndLogMultiApp(true, this.mContext, className, "getProviderInfo");
            throw new PackageManager.NameNotFoundException(className.toString());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public List<PackageInfo> getInstalledPackagesAsUser(int flags, int userId) {
        try {
            ...
            List<PackageInfo> customList = this.mApplicationPackageManagerExt.getInstalledPackagesAsUserExt(parceledList);
            if (customList != null) {
                return customList;
            }
    ...
    public List<ApplicationInfo> getInstalledApplicationsAsUser(int flags, int userId) {
        try {
            ...
            List<ApplicationInfo> customList = this.mApplicationPackageManagerExt.getInstalledApplicationsAsUserExt(parceledList);
            if (customList != null) {
                return customList;
            }
            return parceledList.getList();
    ...
    public Drawable getDefaultActivityIcon() {
        Drawable drawable = this.mApplicationPackageManagerExt.getDefaultActivityIcon(this.mContext);
        if (drawable != null) {
            return drawable;
        }
    ...
    public Drawable getUserBadgedIcon(Drawable icon, UserHandle user) {
        Drawable multiBadge = this.mApplicationPackageManagerExt.getMultiAppUserBadgedIcon(user);
        if (multiBadge != null) {
    ...
    public Drawable getUserBadgeForDensity(UserHandle user, int density) {
        Drawable d;
        int multiAppBadgeId = this.mApplicationPackageManagerExt.getMultiAppUserBadgeId(user, true);
        if (-1 != multiAppBadgeId && (d = getDrawableForDensity(multiAppBadgeId, density)) != null) {
            return d;
        }
    ...
    public Drawable getUserBadgeForDensityNoBackground(UserHandle user, int density) {
        Drawable drawable;
        int multiAppBadgeId = this.mApplicationPackageManagerExt.getMultiAppUserBadgeId(user, false);
        if (-1 != multiAppBadgeId && (drawable = getDrawableForDensity(multiAppBadgeId, density)) != null) {
            return drawable;
        }
        if (!hasUserBadge(user.getIdentifier())) {
            return null;
    ...
    public CharSequence getUserBadgedLabel(CharSequence label, UserHandle user) {
        if (this.mApplicationPackageManagerExt.isMultiAppUserId(user.getIdentifier())) {
            return label;
        }
    ...
    public Resources getResourcesForApplication(ApplicationInfo app, Configuration configuration) throws PackageManager.NameNotFoundException {
        ...
        if (r != null) {
            this.mApplicationPackageManagerExt.modifyResultInGetResourcesForApplication(r, app);
            return r;
        }
    ...
    public ApplicationPackageManager(ContextImpl context, IPackageManager pm) {
        ...
        this.mPM = pm;
        IApplicationPackageManagerExt iApplicationPackageManagerExt = (IApplicationPackageManagerExt) ExtLoader.type(IApplicationPackageManagerExt.class).base(this).create();
        this.mApplicationPackageManagerExt = iApplicationPackageManagerExt;
        iApplicationPackageManagerExt.init(context);
        this.mPackageManagerExt = this.mApplicationPackageManagerExt;
    }
    ...
    public Drawable loadUnbadgedItemIcon(PackageItemInfo itemInfo, ApplicationInfo appInfo) {
        ...
        if (itemInfo.packageName != null) {
            dr = this.mApplicationPackageManagerExt.interceptGetDrawableInLoadUnbadgedItemIcon(this, itemInfo, appInfo);
        }
