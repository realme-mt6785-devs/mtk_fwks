...
public abstract class ClientTransactionHandler {
    public abstract void addLaunchingActivity(IBinder iBinder, ActivityThread.ActivityClientRecord activityClientRecord);
    ...
    public abstract void handleAttachSplashScreenView(ActivityThread.ActivityClientRecord activityClientRecord, SplashScreenView.SplashScreenViewParcelable splashScreenViewParcelable);
    ...
    public abstract void handlePauseActivity(ActivityThread.ActivityClientRecord activityClientRecord, boolean z, boolean z2, int i, PendingTransactionActions pendingTransactionActions, String str);
    ...
    public abstract void handleResumeActivity(ActivityThread.ActivityClientRecord activityClientRecord, boolean z, boolean z2, String str);
    ...
    public abstract void reportRelaunch(ActivityThread.ActivityClientRecord activityClientRecord, PendingTransactionActions pendingTransactionActions);
    ...
    public abstract void updatePendingActivityConfiguration(ActivityThread.ActivityClientRecord activityClientRecord, Configuration configuration);
