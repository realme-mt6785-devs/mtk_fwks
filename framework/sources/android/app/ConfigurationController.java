...
public class ConfigurationController {
    ...
    public IConfigurationControllerExt mConfigurationControllerExt = ConfigurationControllerExtPlugin.constructor.newInstance();
    ...
    public void handleConfigurationChanged(Configuration config, CompatibilityInfo compat) {
        synchronized (this.mResourcesManager) {
            ...
            if (this.mConfiguration.isOtherSeqNewer(config) || compat != null) {
                ...
                if (!this.mConfigurationControllerExt.hookHandleConfigurationChanged(null, config2, configDiff, this.mConfiguration) && callbacks != null) {
