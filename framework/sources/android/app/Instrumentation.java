...
public class Instrumentation {
    ...
    IInstrumentationExt mIInstrumentationExt = InstrumentationExtPlugin.constructor.newInstance();
    ...
    public ActivityResult execStartActivity(Context who, IBinder contextThread, IBinder token, Activity target, Intent intent, int requestCode, Bundle options) {
        ...
        try {
            ...
            try {
                int result2 = service.startActivity(whoThread, opPackageName, attributionTag, intent, resolveTypeIfNeeded, token, str, requestCode, 0, null, options);
    ...
    public int execStartActivitiesAsUser(Context who, IBinder contextThread, IBinder token, Activity target, Intent[] intents, Bundle options, int userId) {
        ...
        try {
            ...
            int result2 = ActivityTaskManager.getService().startActivities(whoThread, who.getOpPackageName(), who.getAttributionTag(), intents, resolvedTypes, token, options, userId);
    ...
    public ActivityResult execStartActivity(Context who, IBinder contextThread, IBinder token, String target, Intent intent, int requestCode, Bundle options) {
        ...
        try {
            intent.migrateExtraStreamToClipData(who);
            intent.prepareToLeaveProcess(who);
            int result2 = ActivityTaskManager.getService().startActivity(whoThread, who.getOpPackageName(), who.getAttributionTag(), intent, intent.resolveTypeIfNeeded(who.getContentResolver()), token, target, requestCode, 0, null, options);
            checkStartActivityResult(result2, intent);
            return null;
        } catch (RemoteException e) {
            throw new RuntimeException("Failure from system", e);
    ...
    public ActivityResult execStartActivity(Context who, IBinder contextThread, IBinder token, String resultWho, Intent intent, int requestCode, Bundle options, UserHandle user) {
        ...
        try {
            ...
            intent.prepareToLeaveProcess(who);
            try {
                int result2 = ActivityTaskManager.getService().startActivityAsUser(whoThread, who.getOpPackageName(), who.getAttributionTag(), intent, intent.resolveTypeIfNeeded(who.getContentResolver()), token, resultWho, requestCode, 0, null, options, user.getIdentifier());
                checkStartActivityResult(result2, intent);
                return null;
            } catch (RemoteException e2) {
                e = e2;
    ...
    public ActivityResult execStartActivityAsCaller(Context who, IBinder contextThread, IBinder token, Activity target, Intent intent, int requestCode, Bundle options, IBinder permissionToken, boolean ignoreTargetSecurity, int userId) {
        ...
        try {
            ...
            intent.prepareToLeaveProcess(who);
            try {
                int result2 = ActivityTaskManager.getService().startActivityAsCaller(whoThread, who.getOpPackageName(), intent, intent.resolveTypeIfNeeded(who.getContentResolver()), token, target != null ? target.mEmbeddedID : null, requestCode, 0, null, options, permissionToken, ignoreTargetSecurity, userId);
                try {
                    checkStartActivityResult(result2, intent);
                    return null;
                } catch (RemoteException e2) {
