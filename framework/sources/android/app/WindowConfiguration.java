...
public class WindowConfiguration implements Parcelable, Comparable<WindowConfiguration> {
    ...
    public static boolean inMultiWindowMode(int windowingMode) {
        return windowingMode != 1 && !WindowConfigurationExtPlugin.isWindowingZoomMode.call(Integer.valueOf(windowingMode)).booleanValue() && !WindowConfigurationExtPlugin.siSWindowingComactMode.call(Integer.valueOf(windowingMode)).booleanValue() && windowingMode != 0;
    }
    ...
    public boolean isAlwaysOnTop() {
        ...
        return i == 5 || WindowConfigurationExtPlugin.isWindowingZoomMode.call(Integer.valueOf(this.mWindowingMode)).booleanValue() || this.mWindowingMode == 6;
    }
    ...
    public static String windowingModeToString(int windowingMode) {
        switch (windowingMode) {
            ...
            case 6:
                return "multi-window";
            default:
                if (WindowConfigurationExtPlugin.siSWindowingComactMode.call(Integer.valueOf(windowingMode)).booleanValue()) {
                    return "oplus-magic-windows";
                }
