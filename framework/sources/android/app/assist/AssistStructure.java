...
public class AssistStructure implements Parcelable {
    ...
    public static final class SendChannel extends Binder {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (token == null) {
                ...
                ParcelTransferWriter xfer2 = (ParcelTransferWriter) token;
        ...
        boolean writeNextEntryToParcel(AssistStructure as, Parcel out, PooledStringWriter pwriter) {
            ...
            if (viewStackEntry == null) {
                ...
                while (true) {
                    ...
                    if (pos2 >= 0) {
                        ViewStackEntry viewStackEntry2 = this.mViewStack.get(pos2);
    ...
    public static class ViewNode {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:18:0x0038, code lost:
            if ((((r25.mWidth & (-32768)) != 0) | ((r25.mHeight & (-32768)) != 0)) != false) goto L_0x003a;
         */
        /*
    ...
    public static class ViewNodeBuilder extends ViewStructure {
        ...
        public void setActivated(boolean state) {
            ViewNode viewNode = this.mNode;
            viewNode.mFlags = (viewNode.mFlags & OplusZoomWindowManager.ACTION_MASK_ON_SHOWING_OF_MINI_ZOOM_MODE) | (state ? 8192 : 0);
        }
