...
public class JobInfo implements Parcelable {
    ...
    public IJobInfoExt mJobInfoExt;
    ...
    private JobInfo(Parcel in) {
        this.mJobInfoExt = JobInfoExtPlugin.constructor.newInstance();
        ...
        this.mJobInfoExt.initJobInfo(in);
    }
    ...
    private JobInfo(Builder b) {
        ...
        this.flags = b.mFlags;
        this.mJobInfoExt.initJobInfoPure(b.mBuilderExt);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        this.mJobInfoExt.writeToParcelJobInfo(out, flags);
    }
    ...
    public static final class Builder {
        ...
        public IJobInfoExt.JobBuilderExt mBuilderExt;
        ...
        public IJobInfoExt.JobBuilderExt makeBuilderExt() {
            if (this.mBuilderExt == null) {
                this.mBuilderExt = new IJobInfoExt.JobBuilderExt();
            }
            return this.mBuilderExt;
        }
        ...
        public Builder(JobInfo job) {
            ...
            this.mBackoffPolicy = 1;
            this.mBackoffPolicySet = false;
            ArrayList<TriggerContentUri> arrayList = null;
            this.mBuilderExt = null;
            ...
            this.mTriggerContentUris = job.getTriggerContentUris() != null ? new ArrayList<>(Arrays.asList(job.getTriggerContentUris())) : arrayList;
    ...
    public void enforceValidity() {
        ...
        if (this.isPeriodic) {
            ...
            } else if (this.minLatencyMillis != 0) {
                throw new IllegalArgumentException("Can't call setMinimumLatency() on a periodic job");
            } else if (this.triggerContentUris != null) {
        ...
        if (this.isPersisted) {
            ...
            } else if (!this.transientExtras.isEmpty()) {
        ...
        if ((i & 2) != 0 && this.hasEarlyConstraint) {
            ...
            } else if (this.hasLateConstraint) {
            ...
            } else if ((this.constraintFlags & (-9)) == 0 && (i & (-25)) == 0) {
                TriggerContentUri[] triggerContentUriArr = this.triggerContentUris;
