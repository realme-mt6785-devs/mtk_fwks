...
public abstract class JobServiceEngine {
    ...
    private static final int MSG_UPDATE_OPLUS_JOB = 1001;
    ...
    static final class JobInterface extends IJobService.Stub {
        ...
        public void updateJobParameters(JobParameters jobParams) throws RemoteException {
            JobServiceEngine service = this.mService.get();
            if (service != null) {
                Message m = Message.obtain(service.mHandler, 1001, jobParams);
                m.sendToTarget();
            }
        }
    }
            ...
            switch (msg.what) {
                ...
                case 1001:
                    try {
                        ...
                        Log.e(JobServiceEngine.TAG, "Application unable to handle onUpdateJobParameters.", e4);
