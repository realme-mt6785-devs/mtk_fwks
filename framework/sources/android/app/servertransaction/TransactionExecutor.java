        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (state) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    this.mTransactionHandler.handleResumeActivity(r, false, r.isForward, "LIFECYCLER_RESUME_ACTIVITY");
                    break;
                case 4:
                    this.mTransactionHandler.handlePauseActivity(r, false, false, 0, this.mPendingActions, "LIFECYCLER_PAUSE_ACTIVITY");
                    break;
                case 5:
