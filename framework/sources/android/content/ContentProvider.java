...
public abstract class ContentProvider implements ContentInterface, ComponentCallbacks2 {
    ...
    private IContentProviderExt mContentProviderExt;
    ...
    public ContentProvider() {
        ...
        this.mContentProviderExt = (IContentProviderExt) ExtLoader.type(IContentProviderExt.class).base(this).create();
    }
    ...
    public class Transport extends ContentProviderNative {
        ...
        public ContentProviderResult[] applyBatch(AttributionSource attributionSource, String authority, ArrayList<ContentProviderOperation> operations) throws OperationApplicationException {
            ...
            for (int i = 0; i < numOperations; i++) {
                ...
                } else if (operation.isWriteOperation() && enforceWritePermission(attributionSource, uri2) != 0) {
                    throw new OperationApplicationException("App op not allowed", 0);
                }
            }
    ...
    public Uri validateIncomingUri(Uri uri) throws SecurityException {
        ...
        if (!this.mSingleUser) {
            ...
            if (this.mContentProviderExt == null) {
                this.mContentProviderExt = (IContentProviderExt) ExtLoader.type(IContentProviderExt.class).base(this).create();
            }
            boolean needSkipMultiapp = this.mContentProviderExt.skipMultiappHandleUri(userId, getUriWithoutUserId(uri));
            if (!(userId == -2 || userId == this.mContext.getUserId() || needSkipMultiapp)) {
    ...
    public static Uri createContentUriForUser(Uri contentUri, UserHandle userHandle) {
        if ("content".equals(contentUri.getScheme())) {
            ...
            if (!uriHasUserId(contentUri)) {
                ...
                return builder.build();
            } else if (String.valueOf(userId).equals(contentUri.getUserInfo())) {
                return contentUri;
            } else {
