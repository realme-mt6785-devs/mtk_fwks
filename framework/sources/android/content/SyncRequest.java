...
public class SyncRequest implements Parcelable {
    ...
    public static class Builder {
        ...
        public SyncRequest build() {
            ...
            } else if ((this.mCustomExtras.getBoolean(ContentResolver.SYNC_EXTRAS_SCHEDULE_AS_EXPEDITED_JOB) || this.mScheduleAsExpeditedJob) && (ContentResolver.hasInvalidScheduleAsEjExtras(this.mCustomExtras) || ContentResolver.hasInvalidScheduleAsEjExtras(this.mSyncConfigExtras))) {
                throw new IllegalArgumentException("Illegal extras were set");
