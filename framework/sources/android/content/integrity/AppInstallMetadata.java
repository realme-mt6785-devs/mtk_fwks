...
public final class AppInstallMetadata {
    ...
    public static final class Builder {
        ...
        public Builder setAppCertificates(List<String> appCertificates) {
            Objects.requireNonNull(appCertificates);
            this.mAppCertificates = appCertificates;
            return this;
        }

        public Builder setInstallerName(String installerName) {
            Objects.requireNonNull(installerName);
            this.mInstallerName = installerName;
            return this;
        }

        public Builder setInstallerCertificates(List<String> installerCertificates) {
            Objects.requireNonNull(installerCertificates);
            this.mInstallerCertificates = installerCertificates;
            return this;
        }
        ...
        public Builder setStampCertificateHash(String stampCertificateHash) {
            Objects.requireNonNull(stampCertificateHash);
            this.mStampCertificateHash = stampCertificateHash;
            return this;
        }
