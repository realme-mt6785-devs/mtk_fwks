...
public class ActivityInfo extends ComponentInfo implements Parcelable {
    ...
    public IActivityInfoExt mActivityInfoExt;
    ...
    public int getRealConfigChanged() {
        this.mActivityInfoExt.getRealConfigChanged(this.name, this.configChanges);
    ...
    public ActivityInfo() {
        ...
        this.mActivityInfoExt = (IActivityInfoExt) ExtLoader.type(IActivityInfoExt.class).base(this).create();
    }
    ...
    public ActivityInfo(ActivityInfo orig) {
        ...
        this.uiOptions = 0;
        this.rotationAnimation = -1;
        IActivityInfoExt iActivityInfoExt = (IActivityInfoExt) ExtLoader.type(IActivityInfoExt.class).base(this).create();
        this.mActivityInfoExt = iActivityInfoExt;
        ...
        iActivityInfoExt.copy(orig.mActivityInfoExt);
    }
    ...
    public void dump(Printer pw, String prefix, int dumpFlags) {
        ...
        this.mActivityInfoExt.dumpFront(pw, prefix);
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        this.mActivityInfoExt.writeToParcel(dest);
    }
    ...
    private ActivityInfo(Parcel source) {
        ...
        this.mActivityInfoExt.readFromParcel(source);
    }
