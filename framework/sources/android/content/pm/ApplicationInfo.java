...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    public final IApplicationInfoExt mApplicationInfoExt;
    ...
    public ApplicationInfo() {
        ...
        IApplicationInfoExt iApplicationInfoExt = (IApplicationInfoExt) ExtLoader.type(IApplicationInfoExt.class).base(this).create();
        this.mApplicationInfoExt = iApplicationInfoExt;
        iApplicationInfoExt.init(this);
    }
    ...
    public ApplicationInfo(ApplicationInfo orig) {
        ...
        iApplicationInfoExt.init(this, orig);
    }
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        if (!dest.maybeWriteSquashed(this)) {
            ...
            this.mApplicationInfoExt.writeToParcel(dest, parcelableFlags);
        }
    }
    ...
    private ApplicationInfo(Parcel source) {
        ...
        this.hiddenUntilInstalled = source.readInt() != 0 ? true : z3;
        ...
        iApplicationInfoExt.init(this, source);
    }
