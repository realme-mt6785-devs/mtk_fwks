...
public class LauncherActivityInfo {
    ...
    public ILauncherActivityInfoExt mLauncherActivityInfoExt = LauncherActivityInfoExtPlugin.constructor.newInstance();
    ...
    public Drawable getBadgedIcon(int density) {
        getIcon(density);
        return this.mLauncherActivityInfoExt.getBadgedIcon(this, density, this.mPm, this.mUser, this.mInternal.getActivityInfo());
    }
}
