...
public class ResolveInfo implements Parcelable {
    ...
    public Drawable loadIcon(PackageManager pm) {
        ...
        if (!(this.resolvePackageName == null || this.iconResourceId == 0)) {
            dr = ResolveInfoExtPlugin.getDrawableByResolvePackageNameInLoadIcon.call(pm, this, this.resolvePackageName, Integer.valueOf(this.iconResourceId));
        }
        ComponentInfo ci = getComponentInfo();
        if (dr == null && this.iconResourceId != 0) {
            ApplicationInfo ai = ci.applicationInfo;
            dr = ResolveInfoExtPlugin.getDrawableByComponentInfoInLoadIcon.call(pm, this, ci.packageName, Integer.valueOf(this.iconResourceId), ai);
        }
        if (dr != null) {
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        dest.writeInt(this.f1system ? 1 : 0);
    ...
    private ResolveInfo(Parcel source) {
        ...
        boolean z = true;
        this.f1system = source.readInt() != 0;
