...
public class Resources {
    ...
    public IResourcesExt mResourcesExt;
    ...
    public Resources(AssetManager assets, DisplayMetrics metrics, Configuration config) {
        ...
        this.mResourcesExt = (IResourcesExt) OplusExtPluginFactory.getInstance().getFeature(IResourcesExt.DEFAULT, this, this.mResourcesImpl.mResourcesImplExt);
    }
    ...
    public Resources(ClassLoader classLoader) {
        ...
        this.mResourcesExt = IResourcesExt.DEFAULT;
    ...
    public TypedArray obtainAttributes(AttributeSet set, int[] attrs) {
        ...
        array.mXml = parser;
        return this.mResourcesImpl.mResourcesImplExt.replaceTypedArray(array);
    }
