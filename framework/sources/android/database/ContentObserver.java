...
public abstract class ContentObserver {
    ...
    public void lambda$dispatchChange$0$ContentObserver(boolean selfChange, Collection<Uri> uris, int flags, int userId) {
    ...
    public final void dispatchChange(final boolean selfChange, final Collection<Uri> uris, final int flags, final int userId) {
        ...
        if (handler == null) {
            lambda$dispatchChange$0$ContentObserver(selfChange, uris, flags, userId);
        } else {
            handler.post(new Runnable() { // from class: android.database.ContentObserver$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ContentObserver.this.lambda$dispatchChange$0$ContentObserver(selfChange, uris, flags, userId);
                }
            });
        }
    }
