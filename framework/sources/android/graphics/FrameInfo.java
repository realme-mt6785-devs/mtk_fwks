...
public final class FrameInfo {
    ...
    public static final long FLAG_CAN_FORCE_DRAW = 256;
    ...
    private static final int OP_FRAME_INFO_SIZE = 10;
    public static final int PERFORM_TRAVERSALS_START = 7;
    public static final int VSYNC = 3;
    public long[] opFrameInfo = new long[10];
    ...
    public void resetOpInfo() {
        for (int i = 0; i < 10; i++) {
            this.opFrameInfo[i] = 0;
        }
    }
