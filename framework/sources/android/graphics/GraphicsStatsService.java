...
public class GraphicsStatsService extends IGraphicsStats.Stub {
    ...
    private void pullGraphicsStatsImpl(boolean lastFullDay, long pulledData) {
        ...
        Throwable th2;
        Throwable th3;
        long targetDay = lastFullDay ? normalizeDate(System.currentTimeMillis() - 86400000).getTimeInMillis() : normalizeDate(System.currentTimeMillis()).getTimeInMillis();
        synchronized (this.mLock) {
            try {
    ...
    private void dumpHistoricalLocked(long dump, HashSet<File> skipFiles) {
        File[] listFiles;
        File[] listFiles2 = this.mGraphicsStatsDir.listFiles();
        int length = listFiles2.length;
        int i = 0;
        while (i < length) {
            File date = listFiles2[i];
            File[] listFiles3 = date.listFiles();
            int length2 = listFiles3.length;
            int i2 = 0;
            while (i2 < length2) {
                File pkg = listFiles3[i2];
