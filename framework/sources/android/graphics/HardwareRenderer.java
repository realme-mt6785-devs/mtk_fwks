...
public class HardwareRenderer extends OplusBaseHardwareRenderer {
    ...
    private static native boolean nSetForceDarkArgs(long j, float f, float f2, float f3);
    ...
    private static native void nSetPackageName(long j, String str);
    ...
    private static native void nSyncOpFrameInfo(long j, long[] jArr, int i);
    ...
    public void setName(String name) {
        ...
        if (str != null) {
            nSetPackageName(this.mNativeProxy, str);
        }
    ...
    public int syncAndDrawFrame(FrameInfo frameInfo) {
        nSyncOpFrameInfo(this.mNativeProxy, frameInfo.opFrameInfo, frameInfo.opFrameInfo.length);
    ...
    @Override // android.graphics.OplusBaseHardwareRenderer
    ...
    public static void setPackageName(String packageName) {
        if (OplusFeatureConfigManager.getInstance().hasFeature(IOplusFeatureConfigList.OPLUS_FEATURE_JANK_TRACKER)) {
    ...
    public boolean setForceDarkArgs(float dialogBgMaxL, float backgroundMaxL, float foregroundMinL) {
        return setUsageForceDarkArgs(dialogBgMaxL, backgroundMaxL, foregroundMinL) && nSetForceDarkArgs(getNativeProxy(), getDarkModeDialogMaxBgMaxL(), backgroundMaxL, foregroundMinL);
    }
}
