...
public class Paint {
    ...
    public Paint(int flags) {
        this.mBidiFlags = 2;
        this.mPaintExt = (IPaintExt) ExtLoader.type(IPaintExt.class).base(this).create();
        ...
        this.mPaintExt.injectedByOemOS(null, this.mNativePaint, this);
    }
    ...
    public Paint(Paint paint) {
        ...
        this.mPaintExt.injectedByOemOS(paint.mTypeface, this.mNativePaint, this);
    }
    ...
    public void set(Paint src) {
        ...
        this.mPaintExt.injectedByOemOS(src.mTypeface, this.mNativePaint, this);
    }
    ...
    public synchronized long getNativeInstance() {
        ...
        this.mPaintExt.setForceZgFont(this.mNativePaint);
    ...
    public Typeface setTypeface(Typeface typeface) {
        ...
        this.mPaintExt.injectedByOemOS(typeface, this.mNativePaint, this);
        return typeface;
    }
