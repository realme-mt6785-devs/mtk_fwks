...
public class Path {
    ...
    public Path() {
        this.mPathExt = (IPathExt) ExtLoader.type(IPathExt.class).base(this).create();
    ...
    public Path(Path src) {
        ...
        if (src != null) {
            ...
            this.mPathExt.hookPath(src.mPathExt);
        }
    ...
    public void addRoundRect(float left, float top, float right, float bottom, float rx, float ry, Direction dir) {
        this.isSimplePath = false;
        this.mPathExt.hookAddRoundRect(left, top, right, bottom, rx, ry, dir);
    ...
    public void addRoundRect(float left, float top, float right, float bottom, float[] radii, Direction dir) {
        if (radii.length >= 8) {
            this.isSimplePath = false;
            this.mPathExt.hookAddRoundRect(left, top, right, bottom, radii, dir);
