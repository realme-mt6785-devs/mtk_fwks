...
public final class RecordingCanvas extends BaseRecordingCanvas {
    private static final int MAX_BITMAP_SIZE_OPLUS = 157286400;
    ...
    public void throwIfCannotDraw(Bitmap bitmap) {
        ...
        if (bitmapSize <= MAX_BITMAP_SIZE_OPLUS) {
            RuntimeException e = new RuntimeException("Canvas: trying to draw too large(" + bitmapSize + "bytes) bitmap.");
            e.printStackTrace();
            return;
        }
