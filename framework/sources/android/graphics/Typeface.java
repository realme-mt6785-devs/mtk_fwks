...
public class Typeface {
    ...
    public ITypefaceExt mTypefaceExt;
    ...
    public static final class CustomFallbackBuilder {
        ...
        private final ArrayList<FontFamily> mFamilies;
    ...
    public static Typeface create(Typeface family, int style) {
        ...
        synchronized (sStyledCacheLock) {
            ...
            typeface2.mTypefaceExt.setSystemTypeface(family.mTypefaceExt.isSystemTypeface());
            return typeface2;
        }
    }
    ...
    public static Typeface createWeightStyle(Typeface base, int weight, boolean italic) {
        ...
        synchronized (sWeightCacheLock) {
            ...
            typeface2.mTypefaceExt.setSystemTypeface(base.mTypefaceExt.isSystemTypeface());
            return typeface2;
        }
    }
    ...
    private Typeface(long ni) {
        this.mTypefaceExt = (ITypefaceExt) OplusExtPluginFactory.getInstance().getFeature(ITypefaceExt.DEFAULT, this);
        if (ni != 0) {
    ...
    public static void initSystemDefaultTypefaces(Map<String, FontFamily[]> fallbacks, List<FontConfig.Alias> aliases, Map<String, Typeface> outSystemFontMap) {
        Typeface base;
        ...
        if (typeface != null) {
            typeface.mTypefaceExt.createIndividualTypefae();
        }
    }
    ...
    public static SharedMemory serializeFontMap(Map<String, Typeface> fontMap) throws IOException, ErrnoException {
        ...
        for (Map.Entry<String, Typeface> entry : fontMap.entrySet()) {
            ...
            entry.getValue().mTypefaceExt.setSystemTypeface(true);
    ...
    public static void setSystemFontMap(SharedMemory sharedMemory) throws IOException, ErrnoException {
        ...
        } else if (sharedMemory != null && sharedMemory != sSystemFontMapSharedMemory) {
    ...
    public static void setSystemFontMap(Map<String, Typeface> systemFontMap) {
        synchronized (SYSTEM_FONT_MAP_LOCK) {
            ...
            sDefaultTypeface.mTypefaceExt.createIndividualTypefae();
    ...
    public static void loadPreinstalledSystemFontMap() {
        ...
        Map<String, FontFamily[]> fallback = SystemFonts.buildSystemFallback(fontConfig);
    ...
    public List<FontFamily> getFallback() {
        ...
        for (int i = 0; i < familySize; i++) {
            families.add(new FontFamily(nativeGetFamily(this.native_instance, i)));
        }
        return families;
    }
}
