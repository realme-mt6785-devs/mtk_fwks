...
public class AdaptiveIconDrawable extends Drawable implements Drawable.Callback {
    ...
    public IAdaptiveIconDrawableExt mIconDrawableExt;
    ...
    AdaptiveIconDrawable(LayerState state, Resources res) {
        ...
        this.mIconDrawableExt = (IAdaptiveIconDrawableExt) ExtLoader.type(IAdaptiveIconDrawableExt.class).base(this).create();
    ...
    public Path getIconMask() {
        return this.mIconDrawableExt.hookGetIconMask() != null ? this.mIconDrawableExt.hookGetIconMask() : this.mMask;
    }
    ...
    private void updateLayerBounds(Rect bounds) {
        if (!bounds.isEmpty()) {
            try {
                ...
                if (!this.mIconDrawableExt.hookOnBoundsChange(bounds)) {
    ...
    public void draw(Canvas canvas) {
        Bitmap bitmap;
        Drawable dr;
        if (!this.mIconDrawableExt.hookDraw(canvas) && (bitmap = this.mLayersBitmap) != null) {
    ...
    public int getIntrinsicWidth() {
        return this.mIconDrawableExt.hookGetIntrinsicWidth() ? getMaxIntrinsicWidth() : (int) (getMaxIntrinsicWidth() * DEFAULT_VIEW_PORT_SCALE);
    }
    ...
    public int getIntrinsicHeight() {
        return this.mIconDrawableExt.hookGetIntrinsicHeight() ? getMaxIntrinsicHeight() : (int) (getMaxIntrinsicHeight() * DEFAULT_VIEW_PORT_SCALE);
    }
    ...
    public Drawable.ConstantState getConstantState() {
        if (this.mIconDrawableExt.shouldHookGetConstantState()) {
            return this.mIconDrawableExt.getConstantState();
        }
