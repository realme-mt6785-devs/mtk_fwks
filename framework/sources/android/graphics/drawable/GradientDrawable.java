...
public class GradientDrawable extends Drawable {
    ...
    public IGradientDrawableExt mGradientDrawableExt;
                ...
                case 0:
                    if (st.mRadiusArray == null) {
                        if (st.mRadius <= 0.0f) {
                            ...
                            IGradientDrawableExt iGradientDrawableExt = this.mGradientDrawableExt;
                            iGradientDrawableExt.drawRoundRect(iGradientDrawableExt.getSmoothRoundStyle(), canvas, this.mRect, rad2, haveStroke, this.mFillPaint, this.mStrokePaint);
                            break;
                        }
                    } else {
                        buildPathIfDirty();
            ...
            if (type != 1) {
                ...
                if (type == 2 && depth <= innerDepth) {
                    ...
                    if (name.equals("size")) {
                        ...
                        a6.recycle();
                    } else if (!this.mGradientDrawableExt.checkElementsName(name)) {
    ...
    private GradientDrawable(GradientState state, Resources res) {
        ...
        this.mPathIsDirty = true;
        this.mGradientDrawableExt = (IGradientDrawableExt) ExtLoader.type(IGradientDrawableExt.class).base(this).create();
    ...
    private void updateLocalState(Resources res) {
        ...
        IGradientDrawableExt iGradientDrawableExt = this.mGradientDrawableExt;
        iGradientDrawableExt.setSmoothRoundStyle(iGradientDrawableExt.getGradientStateSmoothRoundStyle());
