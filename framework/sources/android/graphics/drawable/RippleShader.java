...
final class RippleShader extends RuntimeShader {
    ...
    public void setShader(Shader shader) {
        ...
        setUniform("in_hasMask", shader == null ? 0.0f : 1.0f);
    }

    public void setRadius(float radius) {
        setUniform("in_maxRadius", 2.3f * radius);
    }
    ...
    public void setProgress(float progress) {
        setUniform(SearchManager.CURSOR_EXTRA_KEY_IN_PROGRESS, progress);
    }

    public void setNoisePhase(float phase) {
        setUniform("in_noisePhase", 0.001f * phase);
        setUniform("in_turbulencePhase", phase);
        setUniform("in_tCircle1", new float[]{(float) ((phase * 0.01d * Math.cos(0.8250000000000001d)) + 0.75d), (float) ((phase * 0.01d * Math.sin(0.8250000000000001d)) + 0.75d)});
        setUniform("in_tCircle2", new float[]{(float) ((phase * (-0.0066d) * Math.cos(0.675d)) + 0.30000000000000004d), (float) ((phase * (-0.0066d) * Math.sin(0.675d)) + 0.30000000000000004d)});
        setUniform("in_tCircle3", new float[]{(float) ((phase * (-0.0066d) * Math.cos(0.5249999999999999d)) + 1.5d), (float) ((phase * (-0.0066d) * Math.sin(0.5249999999999999d)) + 1.5d)});
    ...
    public void setResolution(float w, float h) {
        setUniform("in_resolutionScale", new float[]{1.0f / w, 1.0f / h});
        setUniform("in_noiseScale", new float[]{2.1f / w, 2.1f / h});
    }
}
