...
public class StateListDrawable extends DrawableContainer {
    ...
    IStateListDrawableExt mStateListDrawable;
            ...
            if (type2 != i) {
                ...
                if (type2 == 2) {
                    if (depth > innerDepth) {
                        ...
                        Drawable dr2 = a.getDrawable(0);
                        a.recycle();
                        int[] states2 = extractStateSet(attrs);
                        if (dr2 == null) {
                            while (true) {
                                type = parser.next();
                                if (type != 4) {
                            ...
                            if (type == 2) {
                                states = states2;
                                Drawable dr3 = this.mStateListDrawable.hookInflateChildElements(dr2, r.getImpl().mResourcesImplExt, parser, attrs, theme, r, obtainAttributes(r, theme, attrs, R.styleable.ColorDrawable));
                                if (dr3 == null) {
    ...
    private StateListDrawable(StateListState state, Resources res) {
        this.mStateListDrawable = StateListDrawableExtPlugin.constructor.newInstance();
