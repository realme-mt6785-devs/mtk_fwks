...
public final class SystemFonts {
    ...
    private static ISystemFontExt mSystemFontExt;
    private static Set<Font> sAvailableFonts;

    static {
        ISystemFontExt newInstance = SystemFontExtPlugin.constructor.newInstance();
        mSystemFontExt = newInstance;
        FONTS_XML = newInstance.getSystemFontConfig("/system/etc/fonts.xml");
        OEM_XML = mSystemFontExt.getOemCustomizationConfigXml("/product/etc/fonts_customization.xml");
        OEM_FONT_DIR = mSystemFontExt.getOemCustomizationFilePath("/product/fonts/");
    }
    ...
    public static FontConfig getSystemPreinstalledFontConfig() {
        return mSystemFontExt.apendIndividualFontFamily(getSystemFontConfigInternal(FONTS_XML, SYSTEM_FONT_DIR, OEM_XML, OEM_FONT_DIR, null, 0L, 0));
    }
