            ...
            for (int n = 1; n <= maxN; n++) {
                ...
                for (int m = 0; m <= n; m++) {
                    if (n == m) {
                        ...
                        float[][] fArr7 = this.mP;
                        fArr7[n][m] = fArr7[n - 1][m] * cos;
                        float[][] fArr8 = this.mPDeriv;
                        fArr8[n][m] = ((-sin) * fArr7[n - 1][m]) + (fArr8[n - 1][m] * cos);
                    } else {
                        float k = (((n - 1) * (n - 1)) - (m * m)) / (((n * 2) - 1) * ((n * 2) - 3));
                        float[][] fArr9 = this.mP;
                        fArr9[n][m] = (fArr9[n - 1][m] * cos) - (fArr9[n - 2][m] * k);
                        float[][] fArr10 = this.mPDeriv;
                        fArr10[n][m] = (((-sin) * fArr9[n - 1][m]) + (fArr10[n - 1][m] * cos)) - (fArr10[n - 2][m] * k);
                    }
                }
            }
        }
