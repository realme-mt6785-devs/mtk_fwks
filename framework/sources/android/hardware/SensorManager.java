...
public abstract class SensorManager {
    ...
    public static boolean mInMirage;
    ...
    public Sensor getDefaultSensor(int type) {
        ...
        if (type == 8 || type == 17 || type == 22 || type == 23 || type == 24 || type == 25 || type == 26 || type == 32 || type == 36 || type == 65611 || type == 65626 || type == 65612 || type == 65608 || type == 65614 || type == 33171034 || type == 33171056 || type == 33171057) {
            wakeUpSensor = true;
        }
        for (Sensor sensor : l) {
    ...
    public void setSensorAccessState(int uid, boolean state) {
        sensorServiceCommonInterface("setSensorAccessState", uid, state ? 1 : 0);
    }

    public void updateSensorConfing() {
        sensorServiceCommonInterface("updateSensorConfing", 0, 0);
    }

    public void setScreenShotDisable() {
        sensorServiceCommonInterface("setScreenShotDisable", 0, 0);
    }

    public void setCustomizedFlags(int flag, int status) {
        sensorServiceCommonInterface("setCustomizedFlags", flag, status);
    }
