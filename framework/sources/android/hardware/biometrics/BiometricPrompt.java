...
public class BiometricPrompt implements BiometricAuthenticator, BiometricConstants {
    ...
    public class AnonymousClass1 extends IBiometricServiceReceiver.Stub {
        ...
        public void onError(int modality, final int error, int vendorCode) {
            ...
            BiometricPrompt.this.mExecutor.execute(new Runnable() { // from class: android.hardware.biometrics.BiometricPrompt$1$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    BiometricPrompt.AnonymousClass1.this.lambda$onError$2$BiometricPrompt$1(error, errorMessage);
                }
            });
        }
    ...
    public void authenticateUserForOperation(CancellationSignal cancel, Executor executor, AuthenticationCallback callback, int userId, long operationId) {
        if (cancel == null) {
    ...
    private void authenticateInternal(long operationId, CancellationSignal cancel, Executor executor, final AuthenticationCallback callback, int userId) {
        RemoteException e;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    this.mService.authenticate(this.mToken, operationId, userId, this.mBiometricServiceReceiver, this.mContext.getOpPackageName(), promptInfo);
