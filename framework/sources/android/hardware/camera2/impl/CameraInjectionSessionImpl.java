...
public class CameraInjectionSessionImpl extends CameraInjectionSession implements IBinder.DeathRecipient {
    ...
    private void scheduleNotifyError(int errorCode) {
        long ident = Binder.clearCallingIdentity();
        try {
            this.mExecutor.execute(PooledLambda.obtainRunnable(CameraInjectionSessionImpl$$ExternalSyntheticLambda0.INSTANCE, this, Integer.valueOf(errorCode)).recycleOnUse());
        } finally {
            Binder.restoreCallingIdentity(ident);
        }
    }
