...
public class FrameNumberTracker {
    ...
    private void update() {
        ...
        while (iter.hasNext()) {
            ...
            } else if (errorFrameNumber == this.mPendingFrameNumbers[requestType].element()) {
        ...
        if (frameNumber > jArr[requestType]) {
            ...
            if (frameNumber >= maxOtherFrameNumberSeen) {
                ...
                while (true) {
                    ...
                    this.mPendingFrameNumbersWithOtherType[requestType].add(Long.valueOf(i));
                }
            } else if (!this.mPendingFrameNumbers[requestType].isEmpty()) {
