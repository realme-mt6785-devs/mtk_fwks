...
public final class StreamConfigurationMap {
    ...
    public StreamConfigurationMap(StreamConfiguration[] configurations, StreamConfigurationDuration[] minFrameDurations, StreamConfigurationDuration[] stallDurations, StreamConfiguration[] depthConfigurations, StreamConfigurationDuration[] depthMinFrameDurations, StreamConfigurationDuration[] depthStallDurations, StreamConfiguration[] dynamicDepthConfigurations, StreamConfigurationDuration[] dynamicDepthMinFrameDurations, StreamConfigurationDuration[] dynamicDepthStallDurations, StreamConfiguration[] heicConfigurations, StreamConfigurationDuration[] heicMinFrameDurations, StreamConfigurationDuration[] heicStallDurations, HighSpeedVideoConfiguration[] highSpeedVideoConfigurations, ReprocessFormatsMap inputOutputFormatsMap, boolean listHighResolution, boolean enforceImplementationDefined) {
        ...
        while (i < length) {
            ...
            if (config.isOutput()) {
                ...
                if (duration <= DURATION_20FPS_NS) {
                    map = this.mOutputFormats;
                } else {
                    map = this.mHighResOutputFormats;
                }
            } else {
            ...
            i++;
            streamConfigurationArr = streamConfigurationArr;
        }
        StreamConfiguration[] streamConfigurationArr2 = this.mDepthConfigurations;
        int length3 = streamConfigurationArr2.length;
        for (int i3 = 0; i3 < length3; i3++) {
            StreamConfiguration config2 = streamConfigurationArr2[i3];
            if (!config2.isOutput()) {
                streamConfigurationArr2 = streamConfigurationArr2;
                length3 = length3;
            } else {
                streamConfigurationArr2 = streamConfigurationArr2;
                length3 = length3;
        ...
        StreamConfiguration[] streamConfigurationArr3 = this.mDynamicDepthConfigurations;
        int length4 = streamConfigurationArr3.length;
        for (int i4 = 0; i4 < length4; i4++) {
            StreamConfiguration config3 = streamConfigurationArr3[i4];
            if (!config3.isOutput()) {
                streamConfigurationArr3 = streamConfigurationArr3;
                length4 = length4;
            } else {
                streamConfigurationArr3 = streamConfigurationArr3;
                length4 = length4;
        ...
        StreamConfiguration[] streamConfigurationArr4 = this.mHeicConfigurations;
        int length5 = streamConfigurationArr4.length;
        for (int i5 = 0; i5 < length5; i5++) {
            StreamConfiguration config4 = streamConfigurationArr4[i5];
            if (!config4.isOutput()) {
        ...
        if (configurations == null || !enforceImplementationDefined || this.mOutputFormats.indexOfKey(34) >= 0) {
            ...
            int i6 = 0;
            while (i6 < length6) {
                HighSpeedVideoConfiguration config5 = highSpeedVideoConfigurationArr[i6];
