...
public class FaceManager implements BiometricAuthenticator, BiometricFaceConstants {
    ...
    private static final boolean DEBUG_FACE = SystemProperties.getBoolean("persist.sys.assert.panic", false);
    ...
    private final IFaceServiceReceiver mServiceReceiver = new IFaceServiceReceiver.Stub() { // from class: android.hardware.face.FaceManager.1
        ...
        public void onAuthenticationSucceeded(Face face, int userId, boolean isStrongBiometric) {
            ...
            if ("com.android.systemui".equals(FaceManager.this.mContext.getOpPackageName())) {
                FaceManager.this.sendAuthenticatedSucceeded(face, userId, isStrongBiometric);
            } else {
        ...
        public void onRemoved(Face face, int remaining) {
            if (FaceManager.DEBUG_FACE) {
                Slog.d(FaceManager.TAG, "onRemoved remaining = " + remaining);
            }
        ...
        public void onChallengeGenerated(int sensorId, int userId, long challenge) {
            if (FaceManager.DEBUG_FACE) {
                Slog.d(FaceManager.TAG, "onChallengeGenerated!");
            }
            ...
            if (this.mService != null) {
                try {
                    try {
                        ...
                        Slog.d(TAG, "FaceManager#authenticate");
                        this.mService.authenticate(this.mToken, operationId, userId, this.mServiceReceiver, this.mContext.getOpPackageName(), isKeyguardBypassEnabled);
    ...
    public void detectFace(CancellationSignal cancel, FaceDetectionCallback callback, int userId) {
        if (this.mService != null) {
            ...
            try {
                this.mService.detectFace(this.mToken, userId, this.mServiceReceiver, this.mContext.getOpPackageName());
            } catch (RemoteException e) {
    ...
    public void cancelEnrollment() {
        if (this.mService != null) {
            try {
                Slog.d(TAG, "FaceManager#cancelEnrollment");
    ...
    public void cancelAuthentication(CryptoObject cryptoObject) {
        if (this.mService != null) {
            try {
                Slog.d(TAG, "FaceManager#cancelAuthentication");
    ...
    public void cancelFaceDetect() {
        ...
        if (iFaceService != null) {
            try {
                iFaceService.cancelFaceDetect(this.mToken, this.mContext.getOpPackageName());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    private class OnFaceDetectionCancelListener implements CancellationSignal.OnCancelListener {
        private OnFaceDetectionCancelListener() {
        }

        @Override // android.os.CancellationSignal.OnCancelListener
        public void onCancel() {
            FaceManager.this.cancelFaceDetect();
        }
    }
