...
public interface IAGnssCallback extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IAGnssCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{46, 90, -39, -125, 115, 64, 105, -24, 74, 118, 0, 4, -77, 45, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, MidiConstants.STATUS_CHANNEL_PRESSURE, -98, 65, 112, -64, 83, Byte.MIN_VALUE, -85, -30, 126, 110, -72, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 74, -89, IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, 90}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
