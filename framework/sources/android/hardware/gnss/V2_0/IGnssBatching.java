...
public interface IGnssBatching extends android.hardware.gnss.V1_0.IGnssBatching {
    ...
    public static abstract class Stub extends HwBinder implements IGnssBatching {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-37, 107, -33, 109, -4, 94, -33, 108, -123, -46, -108, 73, 118, -37, -119, -110, 39, -85, -75, Tnaf.POW_2_WIDTH, 121, -56, -109, -121, 67, 83, -61, 34, 52, 44, 80, -74}, new byte[]{MidiConstants.STATUS_CONTROL_CHANGE, 92, -104, 60, -121, -61, 55, 110, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, 82, 35, 104, -116, 59, 84, GsmAlphabet.GSM_EXTENDED_ESCAPE, 94, QosProtocol.UDP, -72, 39, MidiConstants.STATUS_SONG_POSITION, QosProtocol.UDP, -29, -115, 90, 49, -81, 28, -93, -94, -30, 34}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
