...
public interface IMeasurementCorrectionsCallback extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IMeasurementCorrectionsCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{62, -20, -105, 99, -37, -101, Tnaf.POW_2_WIDTH, 22, 68, MidiConstants.STATUS_MIDI_TIME_CODE, 65, 117, -73, 124, -103, 84, 4, 116, 69, -92, 104, -23, -57, 67, -3, 64, 45, 71, 45, 74, -87, 126}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
