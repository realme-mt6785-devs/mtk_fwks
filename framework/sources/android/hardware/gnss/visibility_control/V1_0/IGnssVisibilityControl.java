...
public interface IGnssVisibilityControl extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IGnssVisibilityControl {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, 39, -119, 86, -41, -4, 111, -33, -100, -87, -60, 41, 98, -1, 45, 115, -106, 123, -69, 28, -97, 11, 62, 11, 88, -41, GsmAlphabet.GSM_EXTENDED_ESCAPE, 112, -107, -62, -122, -68}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
