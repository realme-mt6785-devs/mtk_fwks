...
public interface IGnssVisibilityControlCallback extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IGnssVisibilityControlCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{QosProtocol.AH, -90, -78, 12, 67, -81, 0, -3, -5, 48, 93, -8, -111, -68, 89, QosProtocol.UDP, -64, 109, -102, -111, 48, -71, 18, 117, -106, 73, -109, 46, 90, 74, 110, 109}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
