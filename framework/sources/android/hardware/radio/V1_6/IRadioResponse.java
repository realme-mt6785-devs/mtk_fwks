...
public interface IRadioResponse extends android.hardware.radio.V1_5.IRadioResponse {
    ...
    public static final class Proxy implements IRadioResponse {
        ...
        @Override // android.hardware.radio.V1_5.IRadioResponse
        public void setupDataCallResponse_1_5(RadioResponseInfo info, android.hardware.radio.V1_5.SetupDataCallResult dcResponse) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.radio.V1_5.IRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
            dcResponse.writeToParcel(_hidl_request);
        ...
        @Override // android.hardware.radio.V1_5.IRadioResponse
        public void getDataCallListResponse_1_5(RadioResponseInfo info, ArrayList<android.hardware.radio.V1_5.SetupDataCallResult> dcResponse) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.radio.V1_5.IRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
        ...
        @Override // android.hardware.radio.V1_5.IRadioResponse
        public void getCellInfoListResponse_1_5(RadioResponseInfo info, ArrayList<android.hardware.radio.V1_5.CellInfo> cellInfo) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.radio.V1_5.IRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
        ...
        @Override // android.hardware.radio.V1_5.IRadioResponse
        public void getIccCardStatusResponse_1_5(RadioResponseInfo info, android.hardware.radio.V1_5.CardStatus cardStatus) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.radio.V1_5.IRadioResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
            cardStatus.writeToParcel(_hidl_request);
