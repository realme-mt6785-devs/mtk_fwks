...
public final class OsAppId {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != OsAppId.class) {
            return false;
        }
        OsAppId other = (OsAppId) otherObject;
        if (!HidlSupport.deepEquals(this.osAppId, other.osAppId)) {
            return false;
        }
        return true;
    }
    ...
    public static final ArrayList<OsAppId> readVectorFromParcel(HwParcel parcel) {
        ArrayList<OsAppId> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 16, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            OsAppId _hidl_vec_element = new OsAppId();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ...
            this.osAppId.add(Byte.valueOf(_hidl_vec_element));
        }
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<OsAppId> _hidl_vec) {
        HwBlob _hidl_blob = new HwBlob(16);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        int _hidl_vec_size = this.osAppId.size();
        _hidl_blob.putInt32(_hidl_offset + 0 + 8, _hidl_vec_size);
        _hidl_blob.putBool(_hidl_offset + 0 + 12, false);
        HwBlob childBlob = new HwBlob(_hidl_vec_size * 1);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            childBlob.putInt8(_hidl_index_0 * 1, this.osAppId.get(_hidl_index_0).byteValue());
        }
