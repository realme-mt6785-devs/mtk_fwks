...
public class SoundTriggerModule {
    ...
    public class EventHandlerDelegate extends ISoundTriggerCallback.Stub implements IBinder.DeathRecipient {
                ...
                public void handleMessage(Message msg) {
                    switch (msg.what) {
                        ...
                        case 2:
                            ...
                            return;
                        case 3:
                            listener.onServiceStateChange(((Integer) msg.obj).intValue());
                            return;
                        default:
        ...
        public synchronized void onRecognition(int handle, RecognitionEvent event) throws RemoteException {
            Message m = this.mHandler.obtainMessage(1, ConversionUtil.aidl2apiRecognitionEvent(handle, event));
            this.mHandler.sendMessage(m);
        }

        @Override // android.media.soundtrigger_middleware.ISoundTriggerCallback
        public synchronized void onPhraseRecognition(int handle, PhraseRecognitionEvent event) throws RemoteException {
            Message m = this.mHandler.obtainMessage(1, ConversionUtil.aidl2apiPhraseRecognitionEvent(handle, event));
            this.mHandler.sendMessage(m);
        }

        @Override // android.media.soundtrigger_middleware.ISoundTriggerCallback
        public synchronized void onRecognitionAvailabilityChange(boolean available) throws RemoteException {
            Message m = this.mHandler.obtainMessage(3, Integer.valueOf(available ? 0 : 1));
            this.mHandler.sendMessage(m);
        }
