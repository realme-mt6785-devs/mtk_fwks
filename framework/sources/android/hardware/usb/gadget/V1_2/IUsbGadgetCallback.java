...
public interface IUsbGadgetCallback extends android.hardware.usb.gadget.V1_0.IUsbGadgetCallback {
    ...
    public static abstract class Stub extends HwBinder implements IUsbGadgetCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-59, 57, QosProtocol.ESP, 91, 34, -68, -26, -122, -121, 111, 6, 43, 22, 41, 32, 56, 85, 90, -30, -123, 126, -115, 52, -86, 99, -87, 117, -33, 24, -31, 19, -79}, new byte[]{-83, 10, 98, 12, -38, 8, -16, GsmAlphabet.GSM_EXTENDED_ESCAPE, 21, 28, 48, -53, 122, -6, 35, MidiConstants.STATUS_CONTROL_CHANGE, 99, 124, -56, 67, 64, -49, -115, -20, 0, -84, -114, QosProtocol.ESP, -49, 84, -88, -37}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
