...
public class LocationManager {
    ...
    public ILocationManagerExt mLocationManagerExt = (ILocationManagerExt) ExtLoader.type(ILocationManagerExt.class).base(this).create();
    ...
    public Location getLastKnownLocation(String provider, LastLocationRequest lastLocationRequest) {
        ...
        if (!this.mLocationManagerExt.checkPermission(Binder.getCallingPid(), Binder.getCallingUid(), "getLastKnownLocation")) {
            return null;
        }
        try {
    ...
    public void requestLocationUpdates(String provider, LocationRequest locationRequest, Executor executor, LocationListener listener) {
        ...
        Preconditions.checkArgument(z, "invalid null location request");
        if (this.mLocationManagerExt.checkPermission(Binder.getCallingPid(), Binder.getCallingUid(), "requestLocationUpdates")) {
            try {
    ...
    public void requestLocationUpdates(String provider, LocationRequest locationRequest, PendingIntent pendingIntent) {
        ...
        if (this.mLocationManagerExt.checkPermission(Binder.getCallingPid(), Binder.getCallingUid(), "requestLocationUpdates")) {
            ...
            if (Compatibility.isChangeEnabled((long) BLOCK_IMMUTABLE_PENDING_INTENTS)) {
                OplusLocationManager locMgr = new OplusLocationManager();
                locMgr.handleCompatibilityException(this.mContext);
    ...
    public boolean registerGnssStatusCallback(GnssStatus.Callback callback, Handler handler) {
        ...
        if (!this.mLocationManagerExt.checkPermission(Binder.getCallingPid(), Binder.getCallingUid(), "registerGnssStatusCallback")) {
            return false;
        }
