...
public final class AudioPlaybackCaptureConfiguration {
    ...
    public int[] getMatchingUsages() {
        return getIntPredicates(1, AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda4.INSTANCE);
    }

    public int[] getMatchingUids() {
        return getIntPredicates(4, AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda3.INSTANCE);
    }

    public int[] getExcludeUsages() {
        return getIntPredicates(32769, AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda2.INSTANCE);
    }

    public int[] getExcludeUids() {
        return getIntPredicates(32772, AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda1.INSTANCE);
    }
