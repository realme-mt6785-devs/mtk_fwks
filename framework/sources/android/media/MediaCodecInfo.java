    ...
    public static final class AudioCapabilities {
        ...
        private void applyLevelLimits() {
            ...
            if (mime.equalsIgnoreCase("audio/mpeg")) {
                ...
                bitRates = Range.create(Integer.valueOf((int) OplusTelephonyConstant.POLL_DORMANT_MILLIS), 510000);
    ...
    public static final class VideoCapabilities {
                ...
                if (key.startsWith("performance-point-")) {
                    ...
                    if (temp.length == 4) {
                        ...
                        if (size != null && size.getWidth() * size.getHeight() > 0) {
                            if (size.getWidth() > ((Integer) MediaCodecInfo.SIZE_RANGE.getUpper()).intValue() || size.getHeight() > ((Integer) MediaCodecInfo.SIZE_RANGE.getUpper()).intValue()) {
                                size = new Size(Math.min(size.getWidth(), ((Integer) MediaCodecInfo.SIZE_RANGE.getUpper()).intValue()), Math.min(size.getHeight(), ((Integer) MediaCodecInfo.SIZE_RANGE.getUpper()).intValue()));
                            }
        ...
        */
        ...
        private void applyLevelLimits() {
            ...
            String str7 = "Unsupported profile ";
            String str8 = "Unrecognized level ";
            String str9 = "Unrecognized profile ";
            String str10 = " for ";
            String str11 = TAG;
            Integer num2 = 1;
            if (equalsIgnoreCase) {
                ...
                int i2 = 0;
                while (i2 < length) {
                    CodecProfileLevel profileLevel = profileLevels6[i2];
                    ...
                    switch (profileLevel.profile) {
                        ...
                        case 8:
                        case 524288:
                            BR6 = BR5 * MetricsProto.MetricsEvent.FIELD_SELECTION_RANGE_START;
                            str7 = str7;
                            break;
                        case 16:
                            BR6 = BR5 * 3000;
                        ...
                        default:
                            str7 = str7;
                            Log.w(str11, str9 + profileLevel.profile + str10 + mime);
                            errors |= 1;
                            BR6 = BR5 * 1000;
                            break;
                    }
                ...
                num = num2;
                String str14 = "/";
                String str15 = "Unrecognized profile/level ";
                if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_MPEG2)) {
                    ...
                    while (MBPS6 < length2) {
                        ...
                        switch (profileLevel2.profile) {
                            case 0:
                                ...
                                switch (profileLevel2.level) {
                                    case 1:
                                        ...
                                        break;
                                    default:
                                        Log.w(str11, str15 + profileLevel2.profile + str14 + profileLevel2.level + str10 + mime);
                                        errors |= 1;
                                        MBPS4 = 0;
                                        FS5 = 0;
                                        str13 = str13;
                            ...
                            default:
                                i = MBPS6;
                                Log.w(str11, str13 + profileLevel2.profile + str10 + mime);
                                errors |= 1;
                                MBPS4 = 0;
                                FS5 = 0;
                                str13 = str13;
                        ...
                        maxBps2 = Math.max(BR4 * 1000, maxBps2);
                        ...
                        length2 = length2;
                        str14 = str14;
                        profileLevels7 = profileLevels7;
                        str15 = str15;
                    }
                    applyMacroBlockLimits(maxWidth, maxHeight, maxBlocks3, maxBlocksPerSecond2, 16, 16, 1, 1);
                    ...
                    if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_MPEG4)) {
                        int maxRate3 = 9;
                        CodecProfileLevel[] profileLevels8 = profileLevels6;
                        int W3 = profileLevels8.length;
                        ...
                        int maxWidth2 = 11;
                        while (i3 < W3) {
                            CodecProfileLevel profileLevel3 = profileLevels8[i3];
                            ...
                            switch (MBPS7) {
                                case 1:
                                    ...
                                    switch (profileLevel3.level) {
                                        ...
                                        case 256:
                                            ...
                                            break;
                                        default:
                                            Log.w(str20, str6 + profileLevel3.profile + str17 + profileLevel3.level + str19 + mime);
                                            errors |= 1;
                                            str20 = str20;
                                            FR4 = 0;
                                            MBPS3 = 0;
                                ...
                                case 16384:
                                    ...
                                    W3 = W3;
                                    profileLevels4 = profileLevels8;
                                    Log.i(str20, str7 + profileLevel3.profile + str19 + mime);
                                    errors |= 2;
                                    supported3 = false;
                                    FR4 = 0;
                                    MBPS3 = 0;
                                ...
                                default:
                                    ...
                                    W3 = W3;
                                    profileLevels4 = profileLevels8;
                                    Log.w(str20, str16 + profileLevel3.profile + str19 + mime);
                                    errors |= 1;
                                    FR4 = 0;
                                    MBPS3 = 0;
                                    FS4 = 0;
                            ...
                            if (H != 0) {
                                int maxWidth3 = Math.max(W, maxWidth2);
                                int maxHeight3 = Math.max(H2, maxRate3);
                                int maxRate4 = Math.max(FR4, maxHeight2);
                                maxWidth2 = maxWidth3;
                                maxRate3 = maxHeight3;
                                maxHeight2 = maxRate4;
                            } else {
                                int maxDim = (int) Math.sqrt(FS4 * 2);
                                int maxWidth4 = Math.max(maxDim, maxWidth2);
                                int maxHeight4 = Math.max(maxDim, maxRate3);
                                maxHeight2 = Math.max(Math.max(FR4, 60), maxHeight2);
                                maxWidth2 = maxWidth4;
                                maxRate3 = maxHeight4;
                            }
                            i3++;
                            profileLevels8 = profileLevels4;
                        }
                        applyMacroBlockLimits(maxWidth2, maxRate3, maxBlocks4, maxBlocksPerSecond3, 16, 16, 1, 1);
                        ...
                        if (mime.equalsIgnoreCase("video/3gpp")) {
                            ...
                            int minH = 0;
                            while (minH < length3) {
                                CodecProfileLevel profileLevel4 = profileLevels9[minH];
                                int BR8 = 0;
                                int minW = minWidth2;
                                ...
                                errors3 &= -5;
                                maxBlocksPerSecond4 = Math.max(MBPS2, maxBlocksPerSecond4);
                                maxBlocks5 = Math.max(minHeight2 * minWidth, maxBlocks5);
                                maxBps4 = Math.max(64000 * BR8, maxBps4);
                                maxWidth5 = Math.max(minHeight2, maxWidth5);
                                maxHeight5 = Math.max(minWidth, maxHeight5);
                                int maxRate5 = Math.max(FR3, maxRate);
                                minWidth2 = Math.min(minW, FR2);
                                minHeight3 = Math.min(minH2, minHeight);
                                minH = MBPS + 1;
                                errors4 = maxRate5;
                                profileLevels9 = profileLevels3;
                                str21 = str4;
                                str20 = str5;
                            }
                            ...
                            applyMacroBlockLimits(minWidth2, minHeight3, maxWidth5, maxHeight5, maxBlocks5, maxBlocksPerSecond4, 16, 16, minAlignment, minAlignment);
                            this.mFrameRateRange = Range.create(num, Integer.valueOf(errors4));
                            errors = errors3;
                            maxBlocks = maxBps4;
                        } else {
                            String str22 = str21;
                            ...
                            if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_VP8)) {
                                int length4 = profileLevels6.length;
                                errors = 4;
                                int i4 = 0;
                                while (i4 < length4) {
                                    CodecProfileLevel profileLevel5 = profileLevels6[i4];
                                ...
                                if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_VP9)) {
                                    ...
                                    int length5 = profileLevels10.length;
                                    errors = 4;
                                    int maxDim2 = 512;
                                    int maxBps5 = 200000;
                                    int maxBps6 = 0;
                                    while (maxBps6 < length5) {
                                        CodecProfileLevel profileLevel6 = profileLevels10[maxBps6];
                                        switch (profileLevel6.level) {
                                            case 1:
                                                profileLevels2 = profileLevels10;
                                                SR2 = 829440;
                                                D3 = 512;
                                                num3 = num3;
                                                FS3 = 36864;
                                            ...
                                            case 8192:
                                                ...
                                                break;
                                            default:
                                                Log.w(str26, str25 + profileLevel6.level + str22 + mime);
                                                errors |= 1;
                                                profileLevels2 = profileLevels10;
                                                SR2 = 0L;
                                                D3 = 0;
                                        ...
                                        maxBps5 = Math.max(BR2 * 1000, maxBps5);
                                        maxDim2 = Math.max(D3, maxDim2);
                                        maxBps6++;
                                        length5 = length5;
                                        profileLevels10 = profileLevels2;
                                    }
                                    num = num3;
                                    ...
                                    if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_HEVC)) {
                                        ...
                                        int length6 = profileLevels10.length;
                                        ...
                                        int i5 = 0;
                                        while (i5 < length6) {
                                            CodecProfileLevel profileLevel7 = profileLevels10[i5];
                                            int FS7 = 0;
                                            int BR9 = 0;
                                            switch (profileLevel7.level) {
                                                ...
                                                case 128:
                                                    FS7 = 552960;
                                                    BR9 = OplusTelephonyConstant.POLL_DORMANT_MILLIS;
                                                    FR = 30.0d;
                                                    str27 = str27;
                                                    break;
                                                case 256:
                                                ...
                                                case 131072:
                                                    FS7 = 8912896;
                                                    BR9 = Protocol.BASE_WIFI_SCANNER_SERVICE;
                                                    FR = 60.0d;
                                                    str27 = str27;
                                                    break;
                                                case 262144:
                                                    FS7 = 8912896;
                                                    BR9 = MediaPlayer.ProvisioningThread.TIMEOUT_MS;
                                                    FR = 120.0d;
                                                    str27 = str27;
                                                    break;
                                                case 524288:
                                            ...
                                            maxBps7 = Math.max(BR9 * 1000, maxBps7);
                                            i5++;
                                            str26 = str26;
                                        }
                                        ...
                                        if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_AV1)) {
                                            ...
                                            int BR10 = profileLevels11.length;
                                            int maxBps8 = 200000;
                                            int maxDim3 = 512;
                                            int errors5 = 4;
                                            int D4 = 0;
                                            while (D4 < BR10) {
                                                CodecProfileLevel profileLevel8 = profileLevels11[D4];
                                                long SR3 = profileLevel8.level;
                                                switch (SR3) {
                                                    case 1:
                                                        profileLevels = profileLevels11;
                                                        D = 2048;
                                                        str30 = str30;
                                                        FS = 147456;
                                                        BR10 = BR10;
                                                    ...
                                                    default:
                                                        str = str29;
                                                        Log.w(str, str30 + profileLevel8.level + str22 + mime);
                                                        profileLevels = profileLevels11;
                                                        errors2 = errors5 | 1;
                                                        D = 0;
                                                        str30 = str30;
