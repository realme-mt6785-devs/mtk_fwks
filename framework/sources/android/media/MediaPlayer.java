...
public class MediaPlayer extends PlayerBase implements SubtitleController.Listener, VolumeAutomation, AudioRouting {
    ...
    /* JADX WARN: Type inference failed for: r3v0, types: [android.media.MediaPlayer$1] */
    ...
    */
    ...
    public static class TimeProvider implements OnSeekCompleteListener, MediaTimeProvider {
        ...
        /* JADX WARN: Removed duplicated region for block: B:19:0x002f A[Catch: IllegalStateException -> 0x007b, all -> 0x00b4, TryCatch #1 {IllegalStateException -> 0x007b, blocks: (B:10:0x000d, B:12:0x0021, B:17:0x0029, B:19:0x002f, B:23:0x0041), top: B:53:0x000d, outer: #0 }] */
        /* JADX WARN: Removed duplicated region for block: B:25:0x0058 A[Catch: all -> 0x00b4, TRY_ENTER, TryCatch #0 {, blocks: (B:3:0x0001, B:6:0x0007, B:7:0x0009, B:10:0x000d, B:12:0x0021, B:17:0x0029, B:19:0x002f, B:23:0x0041, B:25:0x0058, B:27:0x0060, B:29:0x0068, B:30:0x0073, B:31:0x0077, B:32:0x0079, B:35:0x007c, B:37:0x0080, B:39:0x0084, B:41:0x008c, B:42:0x0090, B:44:0x0096, B:45:0x00ae, B:46:0x00b0, B:48:0x00b3), top: B:52:0x0001, inners: #1 }] */
        @Override // android.media.MediaTimeProvider
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public long getCurrentTimeUs(boolean r8, boolean r9) throws java.lang.IllegalStateException {
            /*
                r7 = this;
                monitor-enter(r7)
                boolean r0 = r7.mPaused     // Catch: all -> 0x00b4
                if (r0 == 0) goto L_0x000b
                if (r8 != 0) goto L_0x000b
                long r0 = r7.mLastReportedTime     // Catch: all -> 0x00b4
                monitor-exit(r7)     // Catch: all -> 0x00b4
                return r0
            L_0x000b:
                r0 = 1
                r1 = 0
                android.media.MediaPlayer r2 = r7.mPlayer     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                int r2 = r2.getCurrentPosition()     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                long r2 = (long) r2     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                r4 = 1000(0x3e8, double:4.94E-321)
                long r2 = r2 * r4
                r7.mLastTimeUs = r2     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                android.media.MediaPlayer r2 = r7.mPlayer     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                boolean r2 = r2.isPlaying()     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                if (r2 == 0) goto L_0x0028
                boolean r2 = r7.mBuffering     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
            ...
            L_0x0028:
                r2 = r0
            L_0x0029:
                r7.mPaused = r2     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                boolean r2 = r7.DEBUG     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                if (r2 == 0) goto L_0x0055
                java.lang.String r2 = "MTP"
                java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                r3.<init>()     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                boolean r4 = r7.mPaused     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
            ...
            L_0x0041:
                r3.append(r4)     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                java.lang.String r4 = " at "
                r3.append(r4)     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                long r4 = r7.mLastTimeUs     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                r3.append(r4)     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                java.lang.String r3 = r3.toString()     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
                android.util.Log.v(r2, r3)     // Catch: IllegalStateException -> 0x007b, all -> 0x00b4
            L_0x0055:
                if (r9 == 0) goto L_0x0073
                long r2 = r7.mLastTimeUs     // Catch: all -> 0x00b4
                long r4 = r7.mLastReportedTime     // Catch: all -> 0x00b4
                ...
                r7.mStopped = r1     // Catch: all -> 0x00b4
                r7.mSeeking = r0     // Catch: all -> 0x00b4
                r0 = 3
                r1 = 0
                r7.scheduleNotification(r0, r1)     // Catch: all -> 0x00b4
                goto L_0x0077
            L_0x0073:
                long r0 = r7.mLastTimeUs     // Catch: all -> 0x00b4
                r7.mLastReportedTime = r0     // Catch: all -> 0x00b4
            L_0x0077:
                long r0 = r7.mLastReportedTime     // Catch: all -> 0x00b4
                monitor-exit(r7)     // Catch: all -> 0x00b4
                return r0
            L_0x007b:
                r2 = move-exception
                boolean r3 = r7.mPausing     // Catch: all -> 0x00b4
                if (r3 == 0) goto L_0x00b2
                r7.mPausing = r1     // Catch: all -> 0x00b4
                if (r9 == 0) goto L_0x008c
                long r3 = r7.mLastReportedTime     // Catch: all -> 0x00b4
                long r5 = r7.mLastTimeUs     // Catch: all -> 0x00b4
                int r1 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
                if (r1 >= 0) goto L_0x0090
            L_0x008c:
                long r3 = r7.mLastTimeUs     // Catch: all -> 0x00b4
                r7.mLastReportedTime = r3     // Catch: all -> 0x00b4
            L_0x0090:
                r7.mPaused = r0     // Catch: all -> 0x00b4
                boolean r0 = r7.DEBUG     // Catch: all -> 0x00b4
                ...
                r1.append(r3)     // Catch: all -> 0x00b4
                long r3 = r7.mLastReportedTime     // Catch: all -> 0x00b4
                r1.append(r3)     // Catch: all -> 0x00b4
                java.lang.String r1 = r1.toString()     // Catch: all -> 0x00b4
                android.util.Log.d(r0, r1)     // Catch: all -> 0x00b4
            L_0x00ae:
                long r0 = r7.mLastReportedTime     // Catch: all -> 0x00b4
                monitor-exit(r7)     // Catch: all -> 0x00b4
                return r0
