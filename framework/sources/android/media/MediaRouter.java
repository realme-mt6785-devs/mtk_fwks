        ...
        public final class Client extends IMediaRouterClient.Stub {
            ...
            public void onStateChanged() {
                Static.this.mHandler.post(new Runnable() { // from class: android.media.MediaRouter$Static$Client$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        MediaRouter.Static.Client.this.lambda$onStateChanged$0$MediaRouter$Static$Client();
                    }
                });
            }

            public /* synthetic */ void lambda$onStateChanged$0$MediaRouter$Static$Client() {
            ...
            public void onRestoreRoute() {
                Static.this.mHandler.post(new Runnable() { // from class: android.media.MediaRouter$Static$Client$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        MediaRouter.Static.Client.this.lambda$onRestoreRoute$1$MediaRouter$Static$Client();
                    }
                });
            }

            public /* synthetic */ void lambda$onRestoreRoute$1$MediaRouter$Static$Client() {
            ...
            public void onGroupRouteSelected(final String groupRouteId) {
                Static.this.mHandler.post(new Runnable() { // from class: android.media.MediaRouter$Static$Client$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        MediaRouter.Static.Client.this.lambda$onGroupRouteSelected$2$MediaRouter$Static$Client(groupRouteId);
                    }
                });
            }

            public /* synthetic */ void lambda$onGroupRouteSelected$2$MediaRouter$Static$Client(String groupRouteId) {
                if (this == Static.this.mClient) {
            ...
            @Override // android.media.IMediaRouterClient
            public void onGlobalA2dpChanged(final boolean a2dpOn) {
                Static.this.mHandler.post(new Runnable() { // from class: android.media.MediaRouter$Static$Client$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        MediaRouter.Static.Client.this.lambda$onGlobalA2dpChanged$3$MediaRouter$Static$Client(a2dpOn);
                    }
                });
            }

            public /* synthetic */ void lambda$onGlobalA2dpChanged$3$MediaRouter$Static$Client(boolean a2dpOn) {
                if (Static.this.mSelectedRoute != null && Static.this.mBluetoothA2dpRoute != null) {
                    if (Static.this.mSelectedRoute.isDefault() && a2dpOn) {
                        Static r0 = Static.this;
                        r0.setSelectedRoute(r0.mBluetoothA2dpRoute, false);
                        MediaRouter.dispatchRouteUnselected(1, Static.this.mDefaultAudioVideo);
                        MediaRouter.dispatchRouteSelected(1, Static.this.mBluetoothA2dpRoute);
                    } else if (Static.this.mSelectedRoute.isBluetooth() && !a2dpOn) {
                        Static r02 = Static.this;
                        r02.setSelectedRoute(r02.mDefaultAudioVideo, false);
                        MediaRouter.dispatchRouteUnselected(1, Static.this.mBluetoothA2dpRoute);
                        MediaRouter.dispatchRouteSelected(1, Static.this.mDefaultAudioVideo);
                    }
                }
            }
        }
