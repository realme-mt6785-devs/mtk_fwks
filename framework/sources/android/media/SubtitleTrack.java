...
public abstract class SubtitleTrack implements MediaTimeProvider.OnMediaTimeListener {
    ...
    */
    protected synchronized void updateActiveCues(boolean r8, long r9) {
        ...
        L_0x000c:
            android.media.SubtitleTrack$CueList r0 = r7.mCues     // Catch: all -> 0x00ba
        ...
        L_0x0018:
            ...
            S r2 = r1.second     // Catch: all -> 0x00ba
            android.media.SubtitleTrack$Cue r2 = (android.media.SubtitleTrack.Cue) r2     // Catch: all -> 0x00ba
            long r3 = r2.mEndTimeMs     // Catch: all -> 0x00ba
            F r5 = r1.first     // Catch: all -> 0x00ba
        ...
        L_0x0050:
            java.util.Vector<android.media.SubtitleTrack$Cue> r3 = r7.mActiveCues     // Catch: all -> 0x00ba
        ...
        L_0x009d:
            goto L_0x0018
        L_0x009f:
            android.util.LongSparseArray<android.media.SubtitleTrack$Run> r0 = r7.mRunsByEndTime     // Catch: all -> 0x00ba
