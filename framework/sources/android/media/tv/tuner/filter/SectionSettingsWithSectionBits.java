...
public class SectionSettingsWithSectionBits extends SectionSettings {
    ...
    private SectionSettingsWithSectionBits(int mainType, boolean isCheckCrc, boolean isRepeat, boolean isRaw, byte[] filter, byte[] mask, byte[] mode) {
    ...
    public static class Builder extends SectionSettings.Builder<Builder> {
        ...
        public SectionSettingsWithSectionBits build() {
            return new SectionSettingsWithSectionBits(this.mMainType, this.mCrcEnabled, this.mIsRepeat, this.mIsRaw, this.mFilter, this.mMask, this.mMode);
        }
