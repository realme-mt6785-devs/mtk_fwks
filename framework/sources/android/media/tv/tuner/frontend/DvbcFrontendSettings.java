...
public class DvbcFrontendSettings extends FrontendSettings {
    ...
    private DvbcFrontendSettings(int frequency, int modulation, long innerFec, int symbolRate, int outerFec, int annex, int spectralInversion, int interleaveMode, int bandwidth) {
        super(frequency);
