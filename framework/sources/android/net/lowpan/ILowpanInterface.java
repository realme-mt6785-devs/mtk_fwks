                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 37:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = (IpPrefix) IpPrefix.CREATOR.createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 38:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = (IpPrefix) IpPrefix.CREATOR.createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 39:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = (IpPrefix) IpPrefix.CREATOR.createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 40:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = (IpPrefix) IpPrefix.CREATOR.createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
