...
public final class TunnelModeChildSessionParamsUtils {
    ...
    public static PersistableBundle toPersistableBundle(TunnelModeChildSessionParams params) {
        PersistableBundle result = new PersistableBundle();
        PersistableBundle saProposalBundle = PersistableBundleUtils.fromList(params.getSaProposals(), TunnelModeChildSessionParamsUtils$$ExternalSyntheticLambda3.INSTANCE);
        result.putPersistableBundle(SA_PROPOSALS_KEY, saProposalBundle);
        PersistableBundle inTsBundle = PersistableBundleUtils.fromList(params.getInboundTrafficSelectors(), TunnelModeChildSessionParamsUtils$$ExternalSyntheticLambda4.INSTANCE);
        result.putPersistableBundle(INBOUND_TS_KEY, inTsBundle);
        PersistableBundle outTsBundle = PersistableBundleUtils.fromList(params.getOutboundTrafficSelectors(), TunnelModeChildSessionParamsUtils$$ExternalSyntheticLambda4.INSTANCE);
        ...
        PersistableBundle configReqListBundle = PersistableBundleUtils.fromList(reqList, TunnelModeChildSessionParamsUtils$$ExternalSyntheticLambda5.INSTANCE);
    ...
    private static List<IkeTrafficSelector> getTsFromPersistableBundle(PersistableBundle in, String key) {
        ...
        return PersistableBundleUtils.toList(tsBundle, TunnelModeChildSessionParamsUtils$$ExternalSyntheticLambda1.INSTANCE);
    }
    ...
    public static TunnelModeChildSessionParams fromPersistableBundle(PersistableBundle in) {
        ...
        List<ChildSaProposal> proposals = PersistableBundleUtils.toList(proposalBundle, TunnelModeChildSessionParamsUtils$$ExternalSyntheticLambda0.INSTANCE);
        ...
        List<ConfigRequest> reqList = PersistableBundleUtils.toList(configReqListBundle, TunnelModeChildSessionParamsUtils$$ExternalSyntheticLambda2.INSTANCE);
