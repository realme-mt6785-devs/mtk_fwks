...
public class WifiNl80211Manager {
    ...
    private class ApInterfaceEventCallback extends IApInterfaceEventCallback.Stub {
        ...
        public void onConnectedClientsChanged(final NativeWifiClient client, final boolean isConnected) {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$ApInterfaceEventCallback$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.ApInterfaceEventCallback.this.lambda$onConnectedClientsChanged$0$WifiNl80211Manager$ApInterfaceEventCallback(client, isConnected);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$onConnectedClientsChanged$0$WifiNl80211Manager$ApInterfaceEventCallback(NativeWifiClient client, boolean isConnected) {
        ...
        public void onSoftApChannelSwitched(final int frequency, final int bandwidth) {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$ApInterfaceEventCallback$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.ApInterfaceEventCallback.this.lambda$onSoftApChannelSwitched$1$WifiNl80211Manager$ApInterfaceEventCallback(frequency, bandwidth);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$onSoftApChannelSwitched$1$WifiNl80211Manager$ApInterfaceEventCallback(int frequency, int bandwidth) {
            ...
            if (hiddenNetworkSSIDs != null) {
                for (byte[] ssid : hiddenNetworkSSIDs) {
                    ...
                    if (network.ssid.length > 32) {
                        Log.e(TAG, "Too long after conversion, skip " + network.ssid + " , size = " + network.ssid.length);
