...
public final class NfcAdapter {
    ...
    public INfcAdapterExt mNfcAdapterExt = NfcAdapterExtPlugin.constructor.newInstance();
    ...
    public static NfcAdapter getDefaultAdapter(Context context) {
        ...
        if (context != null) {
            ...
            } else if (getServiceInterface() == null || (manager = (NfcManager) context2.getSystemService("nfc")) == null) {
                return null;
            } else {
    ...
    public boolean enable() {
        if (this.mNfcAdapterExt.hookEnable()) {
            return false;
        }
        try {
    ...
    public boolean disable() {
        if (this.mNfcAdapterExt.hookDisable()) {
            return false;
        }
        try {
