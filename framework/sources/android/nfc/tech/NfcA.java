...
public final class NfcA extends BasicTagTechnology {
    ...
    public NfcA(Tag tag) throws RemoteException {
        super(tag, 1);
        Bundle extras;
        Bundle extras2 = tag.getTechExtras(1);
        this.mSak = extras2.getShort(EXTRA_SAK);
        this.mAtqa = extras2.getByteArray(EXTRA_ATQA);
        if (tag.hasTech(8) && (extras = tag.getTechExtras(8)) != null) {
            this.mSak = (short) (extras.getShort(EXTRA_SAK) | this.mSak);
        }
    }
