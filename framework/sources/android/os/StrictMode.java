...
public final class StrictMode {
    ...
    private static final BlockGuard.VmPolicy VM_ANDROID_POLICY = new BlockGuard.VmPolicy() { // from class: android.os.StrictMode.5
        public void onPathAccess(String path) {
            if (path != null) {
                if (path.startsWith("/data/user/") || path.startsWith("/data/media/") || path.startsWith("/data/system_ce/") || path.startsWith("/data/misc_ce/") || path.startsWith("/data/vendor_ce/") || path.startsWith(BaseOplusMultiAppManager.EXTERNAL_PATH)) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x002c A[Catch: all -> 0x005c, TryCatch #0 {, blocks: (B:6:0x0006, B:8:0x000e, B:10:0x0010, B:12:0x001b, B:15:0x0022, B:18:0x002c, B:19:0x0030, B:20:0x0037, B:21:0x0039), top: B:32:0x0006 }] */
    /* JADX WARN: Removed duplicated region for block: B:19:0x0030 A[Catch: all -> 0x005c, TryCatch #0 {, blocks: (B:6:0x0006, B:8:0x000e, B:10:0x0010, B:12:0x001b, B:15:0x0022, B:18:0x002c, B:19:0x0030, B:20:0x0037, B:21:0x0039), top: B:32:0x0006 }] */
    ...
    */
    public static void decrementExpectedActivityCount(java.lang.Class r7) {
        ...
        L_0x0003:
            ...
            monitor-enter(r0)
            android.os.StrictMode$VmPolicy r1 = android.os.StrictMode.sVmPolicy     // Catch: all -> 0x005c
            int r1 = r1.mask     // Catch: all -> 0x005c
            r1 = r1 & 4
            if (r1 != 0) goto L_0x0010
            monitor-exit(r0)     // Catch: all -> 0x005c
            return
        L_0x0010:
            java.util.HashMap<java.lang.Class, java.lang.Integer> r1 = android.os.StrictMode.sExpectedActivityInstanceCount     // Catch: all -> 0x005c
            java.lang.Object r2 = r1.get(r7)     // Catch: all -> 0x005c
            java.lang.Integer r2 = (java.lang.Integer) r2     // Catch: all -> 0x005c
            r3 = 0
            if (r2 == 0) goto L_0x0029
            int r4 = r2.intValue()     // Catch: all -> 0x005c
        ...
        L_0x002a:
            ...
            r1.remove(r7)     // Catch: all -> 0x005c
            goto L_0x0037
        L_0x0030:
            java.lang.Integer r5 = java.lang.Integer.valueOf(r4)     // Catch: all -> 0x005c
            r1.put(r7, r5)     // Catch: all -> 0x005c
        L_0x0037:
            int r4 = r4 + 1
            monitor-exit(r0)     // Catch: all -> 0x005c
