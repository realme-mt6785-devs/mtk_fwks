...
public final class StorageVolume implements Parcelable {
    ...
    public IStorageVolumeExt mStorageVolumeExt;
    ...
    public StorageVolume(String id, File path, File internalPath, String description, boolean primary, boolean removable, boolean emulated, boolean allowMassStorage, long maxFileSize, UserHandle owner, UUID uuid, String fsUuid, String state) {
        this.mStorageVolumeExt = (IStorageVolumeExt) ExtLoader.type(IStorageVolumeExt.class).base(this).create();
    ...
    private StorageVolume(Parcel in) {
        ...
        this.mStorageVolumeExt.initFromParcel(in);
    }
    ...
    public void dump(IndentingPrintWriter pw) {
        ...
        this.mStorageVolumeExt.dump(pw);
        pw.decreaseIndent();
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        this.mStorageVolumeExt.writeToParcel(parcel, flags);
    }
