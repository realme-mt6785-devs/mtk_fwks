...
public class VolumeInfo implements Parcelable {
    ...
    public IVolumeInfoExt mVolumeInfoExt;
    ...
    public VolumeInfo(String id, int type, DiskInfo disk, String partGuid) {
        this.mVolumeInfoExt = (IVolumeInfoExt) ExtLoader.type(IVolumeInfoExt.class).base(this).create();
        this.mountFlags = 0;
    ...
    public VolumeInfo(Parcel parcel) {
        ...
        this.mVolumeInfoExt.initFromParcel(parcel);
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        this.mVolumeInfoExt.writeToParcel(parcel, flags);
    }
}
