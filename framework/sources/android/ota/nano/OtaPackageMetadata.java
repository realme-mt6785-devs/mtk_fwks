...
public interface OtaPackageMetadata {
    ...
    public static final class DeviceState extends MessageNano {
        ...
        public String[] device;
        public String googlePatch;
        public String googlepatchCheck;
        public String oplusHexNvId;
        public String oplusProjectNumbers;
        ...
        public String securityPatchVendor;
        ...
        public DeviceState clear() {
            ...
            this.versionName = "";
            this.securityPatch = "";
            this.securityPatchVendor = "";
            this.googlePatch = "";
            this.googlepatchCheck = "";
            this.oplusProjectNumbers = "";
            this.buildType = "";
            this.cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (!this.productName.equals("")) {
                output.writeString(21, this.productName);
            }
            if (!this.oplusHexNvId.equals("")) {
                output.writeString(22, this.oplusHexNvId);
            }
            if (!this.otaVersion.equals("")) {
                output.writeString(23, this.otaVersion);
            }
            if (!this.androidVersion.equals("")) {
                output.writeString(24, this.androidVersion);
            }
            if (!this.osVersion.equals("")) {
                output.writeString(25, this.osVersion);
            }
            if (!this.versionName.equals("")) {
                output.writeString(26, this.versionName);
            }
            if (!this.securityPatch.equals("")) {
                output.writeString(27, this.securityPatch);
            }
            if (!this.securityPatchVendor.equals("")) {
                output.writeString(28, this.securityPatchVendor);
            }
            if (!this.googlePatch.equals("")) {
                output.writeString(29, this.googlePatch);
            }
            if (!this.googlepatchCheck.equals("")) {
                output.writeString(30, this.googlepatchCheck);
            }
            if (!this.oplusProjectNumbers.equals("")) {
                output.writeString(31, this.oplusProjectNumbers);
            }
            if (!this.buildType.equals("")) {
                output.writeString(32, this.buildType);
            }
            super.writeTo(output);
        }
        ...
        public int computeSerializedSize() {
            ...
            if (!this.productName.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(21, this.productName);
            }
            if (!this.oplusHexNvId.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(22, this.oplusHexNvId);
            }
            if (!this.otaVersion.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(23, this.otaVersion);
            }
            if (!this.androidVersion.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(24, this.androidVersion);
            }
            if (!this.osVersion.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(25, this.osVersion);
            }
            if (!this.versionName.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(26, this.versionName);
            }
            if (!this.securityPatch.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(27, this.securityPatch);
            }
            if (!this.securityPatchVendor.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(28, this.securityPatchVendor);
            }
            if (!this.googlePatch.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(29, this.googlePatch);
            }
            if (!this.googlepatchCheck.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(30, this.googlepatchCheck);
            }
            if (!this.oplusProjectNumbers.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(31, this.oplusProjectNumbers);
            }
            if (!this.buildType.equals("")) {
                return size + CodedOutputByteBufferNano.computeStringSize(32, this.buildType);
            }
            return size;
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 170:
                        ...
                        break;
                    case 178:
                        this.oplusHexNvId = input.readString();
                        break;
                    case 186:
                        this.otaVersion = input.readString();
                        break;
                    case 194:
                        this.androidVersion = input.readString();
                        break;
                    case 202:
                    ...
                    case 210:
                        ...
                        break;
                    case 218:
                        this.securityPatch = input.readString();
                        break;
                    case 226:
                        this.securityPatchVendor = input.readString();
                        break;
                    case 234:
                        this.googlePatch = input.readString();
                        break;
                    case 242:
                        this.googlepatchCheck = input.readString();
                        break;
                    case 250:
                        this.oplusProjectNumbers = input.readString();
                        break;
                    case 258:
                        this.buildType = input.readString();
                        break;
                    default:
                        if (WireFormatNano.parseUnknownField(input, tag)) {
                            break;
