...
public final class PermissionControllerManager {
    ...
    public void revokeRuntimePermissions(final Map<String, List<String>> request, final boolean doDryRun, final int reason, Executor executor, final OnRevokeRuntimePermissionsCallback callback) {
        ...
        }).whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda25
    ...
    public void setRuntimePermissionGrantStateByDeviceAdmin(final String callerPackageName, final AdminPermissionControlParams params, Executor executor, final Consumer<Boolean> callback) {
        ...
        }).whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda27
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void getRuntimePermissionBackup(final UserHandle user, Executor executor, final Consumer<byte[]> callback) {
        ...
        }).whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda32
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void stageAndApplyRuntimePermissionsBackup(final byte[] backup, final UserHandle user) {
        ...
        }).whenComplete((BiConsumer<? super R, ? super Throwable>) PermissionControllerManager$$ExternalSyntheticLambda33.INSTANCE);
    }
    ...
    public void countPermissionApps(final List<String> permissionNames, final int flags, final OnCountPermissionAppsResultCallback callback, Handler handler) {
        ...
        }).whenComplete((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda22
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void getPermissionUsages(final boolean countSystem, final long numMillis, Executor executor, final OnPermissionUsageResultCallback callback) {
        ...
        }).whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda24
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void grantOrUpgradeDefaultRuntimePermissions(Executor executor, final Consumer<Boolean> callback) {
        this.mRemoteService.postAsync(PermissionControllerManager$$ExternalSyntheticLambda13.INSTANCE).whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda30
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void updateUserSensitiveForApp(final int uid) {
        ...
        }).whenComplete((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda21
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void getPlatformPermissionsForGroup(final String permissionGroupName, Executor executor, final Consumer<List<String>> callback) {
        ...
        }).whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda29
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void getGroupOfPlatformPermission(final String permissionName, Executor executor, final Consumer<String> callback) {
        ...
        }).whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda28
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
