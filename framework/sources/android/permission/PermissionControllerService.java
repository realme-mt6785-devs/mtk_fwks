    ...
    class AnonymousClass1 extends IPermissionController.Stub {
        ...
        public void revokeRuntimePermissions(Bundle bundleizedRequest, boolean doDryRun, int reason, String callerPackageName, final AndroidFuture callback) {
            ...
            for (String packageName : bundleizedRequest.keySet()) {
                ...
                Preconditions.checkCollectionElementsNotNull(permissions, DeviceConfig.NAMESPACE_PERMISSIONS);
            ...
            try {
                ...
                if (getCallingUid() == pkgInfo.applicationInfo.uid) {
                    z = true;
                }
                Preconditions.checkArgument(z);
                PermissionControllerService.this.onRevokeRuntimePermissions(request, doDryRun, reason, callerPackageName, new Consumer() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda7
        ...
        public static /* synthetic */ void lambda$revokeRuntimePermissions$1(AndroidFuture callback, Map revoked) {
            CollectionUtils.forEach(revoked, PermissionControllerService$1$$ExternalSyntheticLambda3.INSTANCE);
        ...
        public static /* synthetic */ void lambda$revokeRuntimePermissions$0(String pkg, List perms) {
            ...
            Preconditions.checkCollectionElementsNotNull(perms, DeviceConfig.NAMESPACE_PERMISSIONS);
        }
        ...
        public void getRuntimePermissionBackup(UserHandle user, ParcelFileDescriptor pipe) {
            ...
            try {
                ...
                try {
                    ...
                    permissionControllerService.onGetRuntimePermissionsBackup(user, backup, new PermissionControllerService$1$$ExternalSyntheticLambda2(latch));
                    latch.await();
                    backup.close();
                } catch (Throwable th) {
                    try {
        ...
        public void stageAndApplyRuntimePermissionsBackup(UserHandle user, ParcelFileDescriptor pipe) {
            ...
            try {
                ...
                try {
                    ...
                    PermissionControllerService permissionControllerService = PermissionControllerService.this;
                    Objects.requireNonNull(latch);
                    permissionControllerService.onStageAndApplyRuntimePermissionsBackup(user, backup, new PermissionControllerService$1$$ExternalSyntheticLambda2(latch));
                    latch.await();
                    backup.close();
                } catch (Throwable th) {
                    try {
        ...
        public void applyStagedRuntimePermissionBackup(String packageName, UserHandle user, AndroidFuture callback) {
            ...
            permissionControllerService.onApplyStagedRuntimePermissionBackup(packageName, user, new PermissionControllerService$1$$ExternalSyntheticLambda4(callback));
        }
        ...
        public void getAppPermissions(String packageName, AndroidFuture callback) {
            ...
            PermissionControllerService permissionControllerService = PermissionControllerService.this;
            Objects.requireNonNull(callback);
            permissionControllerService.onGetAppPermissions(packageName, new PermissionControllerService$1$$ExternalSyntheticLambda6(callback));
        }
        ...
        public void revokeRuntimePermission(String packageName, String permissionName) {
            ...
            PermissionControllerService permissionControllerService = PermissionControllerService.this;
            Objects.requireNonNull(latch);
            permissionControllerService.onRevokeRuntimePermission(packageName, permissionName, new PermissionControllerService$1$$ExternalSyntheticLambda2(latch));
            try {
                latch.await();
        ...
        @Override // android.permission.IPermissionController
        public void countPermissionApps(List<String> permissionNames, int flags, final AndroidFuture callback) {
            ...
            PermissionControllerService permissionControllerService = PermissionControllerService.this;
            Objects.requireNonNull(callback);
            permissionControllerService.onCountPermissionApps(permissionNames, flags, new IntConsumer() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda8
                @Override // java.util.function.IntConsumer
                public final void accept(int i) {
                    AndroidFuture.this.complete(Integer.valueOf(i));
                }
            });
        }
        ...
        public void getPermissionUsages(boolean countSystem, long numMillis, AndroidFuture callback) {
            ...
            PermissionControllerService permissionControllerService = PermissionControllerService.this;
            Objects.requireNonNull(callback);
            permissionControllerService.onGetPermissionUsages(countSystem, numMillis, new PermissionControllerService$1$$ExternalSyntheticLambda6(callback));
        }
        ...
        public void setRuntimePermissionGrantStateByDeviceAdminFromParams(String callerPackageName, AdminPermissionControlParams params, AndroidFuture callback) {
            ...
            PermissionControllerService permissionControllerService = PermissionControllerService.this;
            Objects.requireNonNull(callback);
            permissionControllerService.onSetRuntimePermissionGrantStateByDeviceAdmin(callerPackageName, params, new PermissionControllerService$1$$ExternalSyntheticLambda4(callback));
        }
        ...
        public void grantOrUpgradeDefaultRuntimePermissions(final AndroidFuture callback) {
            Preconditions.checkNotNull(callback, "callback");
            enforceSomePermissionsGrantedToCaller(Manifest.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY);
            PermissionControllerService.this.onGrantOrUpgradeDefaultRuntimePermissions(new Runnable() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda0
        ...
        public void updateUserSensitiveForApp(int uid, final AndroidFuture callback) {
            ...
            enforceSomePermissionsGrantedToCaller(Manifest.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY);
            try {
                PermissionControllerService.this.onUpdateUserSensitivePermissionFlags(uid, new Runnable() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void getPlatformPermissionsForGroup(String permissionName, AndroidFuture<List<String>> callback) {
            try {
                ...
                PermissionControllerService permissionControllerService = PermissionControllerService.this;
                Objects.requireNonNull(callback);
                permissionControllerService.onGetPlatformPermissionsForGroup(permissionName, new PermissionControllerService$1$$ExternalSyntheticLambda6(callback));
            } catch (Throwable t) {
                callback.completeExceptionally(t);
            }
        }
        ...
        public void getGroupOfPlatformPermission(String permissionGroupName, final AndroidFuture<String> callback) {
            try {
                ...
                PermissionControllerService permissionControllerService = PermissionControllerService.this;
                Objects.requireNonNull(callback);
                permissionControllerService.onGetGroupOfPlatformPermission(permissionGroupName, new Consumer() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda5
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
