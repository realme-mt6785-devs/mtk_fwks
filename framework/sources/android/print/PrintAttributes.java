...
import android.net.wifi.p2p.IOplusWifiP2pManager;
...
public final class PrintAttributes implements Parcelable {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_LETTER = new MediaSize("NA_LETTER", "android", R.string.mediasize_na_letter, 8500, IOplusWifiP2pManager.OPLUS_CALL_TRANSACTION_INDEX);
        ...
        public static final MediaSize NA_LEDGER = new MediaSize("NA_LEDGER", "android", R.string.mediasize_na_ledger, 17000, IOplusWifiP2pManager.OPLUS_CALL_TRANSACTION_INDEX);
        public static final MediaSize NA_TABLOID = new MediaSize("NA_TABLOID", "android", R.string.mediasize_na_tabloid, IOplusWifiP2pManager.OPLUS_CALL_TRANSACTION_INDEX, 17000);
        public static final MediaSize NA_INDEX_3X5 = new MediaSize("NA_INDEX_3X5", "android", R.string.mediasize_na_index_3x5, 3000, 5000);
        public static final MediaSize NA_INDEX_4X6 = new MediaSize("NA_INDEX_4X6", "android", R.string.mediasize_na_index_4x6, 4000, OplusTelephonyConstant.POLL_DORMANT_MILLIS);
