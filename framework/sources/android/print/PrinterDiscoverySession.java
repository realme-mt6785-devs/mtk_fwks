    ...
    */
    private void destroyNoCheck() {
        /*
            ...
            r0 = 0
            android.print.IPrintManager r1 = r4.mPrintManager     // Catch: all -> 0x0016, RemoteException -> 0x0018
            android.print.IPrinterDiscoveryObserver r2 = r4.mObserver     // Catch: all -> 0x0016, RemoteException -> 0x0018
            int r3 = r4.mUserId     // Catch: all -> 0x0016, RemoteException -> 0x0018
            r1.destroyPrinterDiscoverySession(r2, r3)     // Catch: all -> 0x0016, RemoteException -> 0x0018
        L_0x000e:
            r4.mObserver = r0
            java.util.LinkedHashMap<android.print.PrinterId, android.print.PrinterInfo> r0 = r4.mPrinters
            r0.clear()
            goto L_0x0022
        L_0x0016:
            r1 = move-exception
        ...
        L_0x0018:
            r1 = move-exception
            java.lang.String r2 = "PrinterDiscoverySession"
            java.lang.String r3 = "Error destroying printer discovery session"
            android.util.Log.e(r2, r3, r1)     // Catch: all -> 0x0016
            goto L_0x000e
        L_0x0022:
            return
        L_0x0023:
