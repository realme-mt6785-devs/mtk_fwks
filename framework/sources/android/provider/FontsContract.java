...
public class FontsContract {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Unreachable block: B:40:0x0079
    ...
    private static java.util.Map<android.net.Uri, java.nio.ByteBuffer> prepareFontData(android.content.Context r18, android.provider.FontsContract.FontInfo[] r19, android.os.CancellationSignal r20) {
        ...
        L_0x002a:
            ...
            r9 = r20
            android.os.ParcelFileDescriptor r0 = r3.openFileDescriptor(r7, r0, r9)     // Catch: IOException -> 0x0077
            r10 = r0
            if (r10 == 0) goto L_0x0071
            java.io.FileInputStream r0 = new java.io.FileInputStream     // Catch: all -> 0x0062, IOException -> 0x0070
            java.io.FileDescriptor r11 = r10.getFileDescriptor()     // Catch: all -> 0x0062, IOException -> 0x0070
            r0.<init>(r11)     // Catch: all -> 0x0062, IOException -> 0x0070
            r11 = r0
            java.nio.channels.FileChannel r12 = r11.getChannel()     // Catch: all -> 0x0056
            long r16 = r12.size()     // Catch: all -> 0x0056
            java.nio.channels.FileChannel$MapMode r13 = java.nio.channels.FileChannel.MapMode.READ_ONLY     // Catch: all -> 0x0056
            r14 = 0
            java.nio.MappedByteBuffer r0 = r12.map(r13, r14, r16)     // Catch: all -> 0x0056
            r8 = r0
            r11.close()     // Catch: all -> 0x0062, IOException -> 0x0070
            goto L_0x0071
        L_0x0056:
            r0 = move-exception
            r12 = r0
            r11.close()     // Catch: all -> 0x005c
            goto L_0x0061
        L_0x005c:
            r0 = move-exception
            r13 = r0
            r12.addSuppressed(r13)     // Catch: all -> 0x0062, IOException -> 0x0070
        L_0x0061:
            throw r12     // Catch: all -> 0x0062, IOException -> 0x0070
        L_0x0062:
            r0 = move-exception
            r11 = r0
            if (r10 == 0) goto L_0x006f
            r10.close()     // Catch: all -> 0x006a
            goto L_0x006f
        L_0x006a:
            r0 = move-exception
            r12 = r0
            r11.addSuppressed(r12)     // Catch: IOException -> 0x0077
        L_0x006f:
            throw r11     // Catch: IOException -> 0x0077
        L_0x0070:
            r0 = move-exception
        L_0x0071:
