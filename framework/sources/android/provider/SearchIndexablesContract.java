...
public class SearchIndexablesContract {
    ...
    public static final String[] INDEXABLES_XML_RES_COLUMNS = {"rank", XmlResource.COLUMN_XML_RESID, BaseColumns.COLUMN_CLASS_NAME, "iconResId", BaseColumns.COLUMN_INTENT_ACTION, BaseColumns.COLUMN_INTENT_TARGET_PACKAGE, BaseColumns.COLUMN_INTENT_TARGET_CLASS};
