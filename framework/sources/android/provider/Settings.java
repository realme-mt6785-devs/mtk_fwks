...
public final class Settings {
    ...
    public static class NameValueCache {
        ...
        /* JADX WARN: Removed duplicated region for block: B:85:0x019a A[Catch: RemoteException -> 0x01f2, TryCatch #7 {RemoteException -> 0x01f2, blocks: (B:60:0x0110, B:63:0x011f, B:75:0x0141, B:77:0x0147, B:79:0x0151, B:82:0x0171, B:83:0x017d, B:85:0x019a, B:87:0x01a4, B:107:0x01f1, B:89:0x01a7, B:92:0x01ba, B:94:0x01c4, B:95:0x01c7, B:96:0x01d5, B:98:0x01d9, B:100:0x01df, B:101:0x01e4, B:81:0x0157), top: B:165:0x0110 }] */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:72:0x0139 -> B:106:0x01f0). Please submit an issue!!! */
        /*
                ...
                try {
                    ...
                    if (generationTracker != null) {
                        try {
                            ...
                            Log.d(Settings.TAG, "Setting: getStringsForPrefix FD closed by unknown reason, " + e.getMessage());
                            this.mGenerationTracker = null;
                        }
                    }
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            SettingsExtPlugin.addKeyToPublicSettings.call(arraySet);
        ...
        public static int getIntForUser(ContentResolver cr, String name, int def, int userHandle) {
            ...
            try {
                int result = SettingsExtPlugin.getAutoBrightnessValueForUserWithDef.call(name, v, Integer.valueOf(def)).intValue();
                return result != Integer.MIN_VALUE ? result : v != null ? Integer.parseInt(v) : def;
        ...
        public static int getIntForUser(ContentResolver cr, String name, int userHandle) throws SettingNotFoundException {
            String v = getStringForUser(cr, name, userHandle);
            try {
                int result = SettingsExtPlugin.getAutoBrightnessValueForUser.call(cr, name, v).intValue();
                return result != Integer.MIN_VALUE ? result : Integer.parseInt(v);
            } catch (NumberFormatException e) {
        ...
        public static boolean putIntForUser(ContentResolver cr, String name, int value, int userHandle) {
            return putStringForUser(cr, name, Integer.toString(SettingsExtPlugin.putAutoBrightnessValueForUser.call(cr, cr.getPackageName(), name, Integer.valueOf(value)).intValue()), userHandle);
        }
    ...
    public static final class Secure extends NameValueTable {
        ...
        public static String getStringForUser(ContentResolver resolver, String name, int userHandle) {
            boolean isPreMnc = false;
            int userHandle2 = SettingsExtPlugin.redirectUserIfNeeded.call(Integer.valueOf(userHandle), name).intValue();
            if (MOVED_TO_GLOBAL.contains(name)) {
                ...
                return Global.getStringForUser(resolver, name, userHandle2);
            }
            if (MOVED_TO_LOCK_SETTINGS.contains(name)) {
                ...
                if (sLockSettings != null && !sIsSystemProcess) {
                    ...
                    if (isPreMnc) {
                        try {
                            return sLockSettings.getString(name, "0", userHandle2);
                        } catch (RemoteException e) {
                        }
                    } else {
            ...
            return sNameValueCache.getStringForUser(resolver, name, userHandle2);
        }
        ...
        public static boolean putStringForUser(ContentResolver resolver, String name, String value, String tag, boolean makeDefault, int userHandle, boolean overrideableByRestore) {
            if (DEFAULT_INPUT_METHOD.equals(name)) {
                Log.v(Settings.TAG, "Callstack for DEFAULT_INPUT_METHOD: " + value, new Throwable());
            }
            if (!MOVED_TO_GLOBAL.contains(name)) {
