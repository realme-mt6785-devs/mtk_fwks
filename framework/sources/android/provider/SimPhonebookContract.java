...
public final class SimPhonebookContract {
    ...
    public static final class SimRecords {
        ...
        private static Uri.Builder buildContentUri(int subscriptionId, int efType) {
            return new Uri.Builder().scheme("content").authority(SimPhonebookContract.AUTHORITY).appendPath("subid").appendPath(String.valueOf(subscriptionId)).appendPath(SimPhonebookContract.getEfUriPath(efType));
        }
    }
    ...
    public static final class ElementaryFiles {
        ...
        public static Uri getItemUri(int subscriptionId, int efType) {
            return CONTENT_URI.buildUpon().appendPath("subid").appendPath(String.valueOf(subscriptionId)).appendPath(SimPhonebookContract.getEfUriPath(efType)).build();
        }
    }
}
