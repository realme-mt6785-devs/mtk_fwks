...
public class AndroidKeyStoreSpi extends KeyStoreSpi {
        ...
        try {
            ...
            if (chain.length > 1) {
                ...
                for (int i2 = 0; i2 < certsBytes.length; i2++) {
                    try {
                        ...
                        throw new java.security.KeyStoreException("Failed to encode certificate #" + i2, e3);
                    }
                }
            ...
            if (key instanceof AndroidKeyStorePrivateKey) {
                ...
                try {
                    ...
                    throw new java.security.KeyStoreException("Failed to store certificate and certificate chain", e4);
                }
            } else {
                ...
                if (pkcs8EncodedPrivateKeyBytes != null) {
                    ...
                    try {
                        ...
                        int i5 = 0;
                        for (int length2 = blockModes.length; i5 < length2; length2 = length2) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                throw new java.security.KeyStoreException("Failed to store certificate and certificate chain", e7);
                            }
                        } catch (KeyStoreException e8) {
                            e2 = e8;
                            throw new java.security.KeyStoreException("Failed to store private key", e2);
                        }
    ...
    private static void assertCanReplace(String alias, int targetDomain, int targetNamespace, KeyDescriptor descriptor) throws java.security.KeyStoreException {
        String str;
        if (alias != descriptor.alias || descriptor.domain != targetDomain || (descriptor.domain == 2 && descriptor.nspace != targetNamespace)) {
                            ...
                            try {
                                ...
                                if (params.getSignaturePaddings().length <= 0) {
                                    ...
                                    try {
                                        ...
                                        e2 = e4;
                                        throw new java.security.KeyStoreException("Failed to import secret key.", e2);
                                    }
                                } else {
                                    try {
        ...
        if (param == null) {
            ...
            if (KeyProperties.KEY_ALGORITHM_RSA.equalsIgnoreCase(algorithm)) {
                ...
                try {
                    ...
                    throw new java.security.KeyStoreException("Failed to import wrapped key. Keystore error code: " + e4.getErrorCode(), e4);
                }
            } else {
