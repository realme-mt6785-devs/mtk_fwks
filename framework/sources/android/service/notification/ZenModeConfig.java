...
public class ZenModeConfig implements Parcelable {
    ...
    public static ZenPolicy readZenPolicyXml(TypedXmlPullParser parser) {
        ...
        int system2 = safeInt(parser, "system", 0);
    ...
    public static Condition toTimeCondition(Context context, long time, int minutes, int userHandle, boolean shortVersion) {
        ...
        if (minutes < 60) {
            ...
            line2 = res.getQuantityString(line1ResId, minutes, Integer.valueOf(minutes), formattedTime);
            ...
            line2 = res.getQuantityString(line1ResId2, num, Integer.valueOf(num), formattedTime);
            line22 = res.getString(R.string.zen_mode_until, formattedTime);
        } else {
            line22 = res.getString(R.string.zen_mode_until_next_day, formattedTime);
            summary = line22;
            line2 = line22;
        }
        Uri id = toCountdownConditionId(time, false);
        return new Condition(id, summary, line2, line22, 0, 1, 1);
    }
    ...
    private static String getConditionLine(Context context, ZenModeConfig config, int userHandle, boolean useLine1, boolean shortVersion) {
        ...
        if (zenRule != null) {
            ...
            if (config.manualRule.enabler != null) {
                ...
                String rt = c == null ? summary : useLine1 ? c.line1 : c.summary;
