...
public class SessionManager {
    ...
    public Runnable mCleanStaleSessions = new Runnable() { // from class: android.telecom.Logging.SessionManager$$ExternalSyntheticLambda2
    ...
    private synchronized void resetStaleSessionTimer() {
        ...
        Runnable runnable = this.mCleanStaleSessions;
        if (runnable != null) {
