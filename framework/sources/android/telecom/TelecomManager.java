...
public class TelecomManager {
    ...
    private static final String PACKAGE_NAME_KEY = "oplus_package_name";
    ...
    public void oplusCancelMissedCallsNotification(Bundle extras) {
        Log.i(TAG, "oplusCancelMissedCallsNotification intent = " + extras);
        ITelecomService service = getTelecomService();
        if (service != null) {
            try {
                service.oplusCancelMissedCallsNotification(this.mContext.getOpPackageName(), extras);
            } catch (RemoteException e) {
                Log.e(TAG, "Error calling ITelecomService#oplusCancelMissedCallsNotification", e);
            }
        }
    }
