...
public final class BarringInfo implements Parcelable {
    ...
    public static BarringInfo create(CellIdentity halBarringCellId, List<android.hardware.radio.V1_5.BarringInfo> halBarringInfos) {
        ...
        for (android.hardware.radio.V1_5.BarringInfo halBarringInfo : halBarringInfos) {
            ...
            } else if (halBarringInfo.barringTypeSpecificInfo.getDiscriminator() == 1) {
