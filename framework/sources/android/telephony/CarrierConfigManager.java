...
public class CarrierConfigManager {
    ...
    public static final class Gps {
        ...
        public static PersistableBundle getDefaults() {
            ...
            defaults.putString(KEY_SUPL_MODE_STRING, IOplusUIFirstManager.APP_START_ANIMATION);
            defaults.putString(KEY_SUPL_ES_STRING, IOplusUIFirstManager.APP_START_ANIMATION);
            defaults.putString(KEY_LPP_PROFILE_STRING, IOplusUIFirstManager.APP_EXIT_ANIMATION);
            defaults.putString(KEY_USE_EMERGENCY_PDN_FOR_EMERGENCY_SUPL_STRING, IOplusUIFirstManager.APP_START_ANIMATION);
    ...
    static {
        ...
        persistableBundle.putBoolean(KEY_VILTE_DATA_IS_METERED_BOOL, false);
        ...
        persistableBundle.putBoolean(KEY_TTY_SUPPORTED_BOOL, false);
        ...
        try {
            Class<?> extCarrierConfigManagerClass = Class.forName("mediatek.telephony.MtkCarrierConfigManager", false, ClassLoader.getSystemClassLoader());
            Method extCarrierConfigManagerMethod = extCarrierConfigManagerClass.getMethod("putDefault", PersistableBundle.class);
            extCarrierConfigManagerMethod.invoke(null, persistableBundle);
        } catch (Exception e) {
            Rlog.w(TAG, "No MtkCarrierConfigManager! Do nothing. - " + e);
        }
        CarrierConfigManagerPlugIn.constructor.newInstance().putDefault(sDefaults);
    }
