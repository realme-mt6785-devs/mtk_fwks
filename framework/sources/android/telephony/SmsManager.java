...
public final class SmsManager {
    ...
    private void sendTextMessageInternal(final String destinationAddress, final String scAddress, final String text, final PendingIntent sentIntent, final PendingIntent deliveryIntent, final boolean persistMessage, int priority, final boolean expectMore, int validityPeriod) {
        final int priority2;
        final int validityPeriod2 = validityPeriod;
        if (TextUtils.isEmpty(destinationAddress)) {
            throw new IllegalArgumentException("Invalid destinationAddress");
        } else if (!TextUtils.isEmpty(text)) {
                ...
                resolveSubscriptionForOperation(new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.2
                    ...
                    public void onSuccess(int subId) {
                        try {
                            ISms iSms = SmsManager.getISmsServiceOrThrow();
                            if (iSms != null) {
                                iSms.sendTextForSubscriberWithOptions(subId, null, null, destinationAddress, scAddress, text, sentIntent, deliveryIntent, persistMessage, priority2, expectMore, validityPeriod2);
                            }
                        } catch (RemoteException e) {
            ...
            try {
                ISms iSms = getISmsServiceOrThrow();
                if (iSms != null) {
                    iSms.sendTextForSubscriberWithOptions(getSubscriptionId(), null, null, destinationAddress, scAddress, text, sentIntent, deliveryIntent, persistMessage, priority2, expectMore, validityPeriod2);
                }
            } catch (RemoteException e) {
            ...
            if (parts.size() <= 1) {
                ...
                resolveSubscriptionForOperation(new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.4
                    ...
                    public void onSuccess(int subId) {
                        try {
                            ISms iSms = SmsManager.getISmsServiceOrThrow();
                            if (iSms != null) {
                                iSms.sendMultipartTextForSubscriberWithOptions(subId, null, null, destinationAddress, scAddress, parts, sentIntents, deliveryIntents, persistMessage, priority2, expectMore, validityPeriod2);
                            }
                        } catch (RemoteException e2) {
                            Log.e(SmsManager.TAG, "sendMultipartTextMessageInternal: Couldn't send SMS - " + e2.getMessage());
                            SmsManager.notifySmsError(sentIntents, 31);
                        }
                    }
                ...
                try {
                    ...
                    if (iSms != null) {
                        list = sentIntents;
                        try {
                            iSms.sendMultipartTextForSubscriberWithOptions(getSubscriptionId(), null, null, destinationAddress, scAddress, parts, sentIntents, deliveryIntents, persistMessage, priority2, expectMore, validityPeriod2);
                        } catch (RemoteException e2) {
                            e = e2;
    ...
    private void resolveSubscriptionForOperation(final SubscriptionResolverResult resolverResult) {
        ...
        if (!checkSimPickActivityNeeded(isSmsSimPickActivityNeeded)) {
