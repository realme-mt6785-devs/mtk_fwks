    ...
    public void reflow(CharSequence s, int where, int before, int after) {
        ...
        if (s == this.mBase) {
            ...
            while (i2 < n2) {
                ...
                int where4 = reflowed2.getStartHyphenEdit(i2);
                int after4 = reflowed2.getEndHyphenEdit(i2);
                ints[4] = StaticLayout.packHyphenEdit(where4, after4);
    ...
    public void updateBlocks(int startLine, int endLine, int newLineCount) {
        ...
        while (true) {
            if (i3 >= this.mNumberOfBlocks) {
                break;
            } else if (this.mBlockEndLines[i3] >= startLine) {
                firstBlock = i3;
                break;
            } else {
                i3++;
        ...
        while (true) {
            ...
            if (i4 >= i) {
                break;
            } else if (this.mBlockEndLines[i4] >= endLine) {
                lastBlock = i4;
                break;
            } else {
                i4++;
