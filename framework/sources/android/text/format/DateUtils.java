...
public class DateUtils {
    ...
    public static String formatElapsedTime(StringBuilder recycle, long elapsedSeconds) {
        ...
        initFormatStrings();
        return hours > 0 ? f.format(sElapsedFormatHMMSS, Long.valueOf(hours), Long.valueOf(minutes), Long.valueOf(elapsedSeconds2)).toString() : f.format(sElapsedFormatMMSS, Long.valueOf(minutes), Long.valueOf(elapsedSeconds2)).toString();
    }
