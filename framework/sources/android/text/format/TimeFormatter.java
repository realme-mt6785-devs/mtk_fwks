...
class TimeFormatter {
    ...
    */
    public java.lang.String format(java.lang.String r5, com.android.i18n.timezone.WallTime r6, com.android.i18n.timezone.ZoneInfoData r7) {
        /*
            r4 = this;
            r0 = 0
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch: all -> 0x0021
            r1.<init>()     // Catch: all -> 0x0021
            r4.outputBuilder = r1     // Catch: all -> 0x0021
            java.util.Formatter r2 = new java.util.Formatter     // Catch: all -> 0x0021
            java.util.Locale r3 = java.util.Locale.US     // Catch: all -> 0x0021
            r2.<init>(r1, r3)     // Catch: all -> 0x0021
            r4.numberFormatter = r2     // Catch: all -> 0x0021
            r4.formatInternal(r5, r6, r7)     // Catch: all -> 0x0021
            java.lang.String r2 = r1.toString()     // Catch: all -> 0x0021
            java.lang.String r3 = r4.localizeDigits(r2)     // Catch: all -> 0x0021
            r4.outputBuilder = r0
            r4.numberFormatter = r0
            return r3
        L_0x0021:
            r1 = move-exception
            r4.outputBuilder = r0
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.text.format.TimeFormatter.format(java.lang.String, com.android.i18n.timezone.WallTime, com.android.i18n.timezone.ZoneInfoData):java.lang.String");
    }
