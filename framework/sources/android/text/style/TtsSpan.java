...
public class TtsSpan implements ParcelableSpan {
    ...
    public static class SemioticClassBuilder<C extends SemioticClassBuilder<?>> extends Builder<C> {
        ...
        public C setGender(String gender) {
            return (C) ((SemioticClassBuilder) setStringArgument(TtsSpan.ARG_GENDER, gender));
        }

        public C setAnimacy(String animacy) {
            return (C) ((SemioticClassBuilder) setStringArgument(TtsSpan.ARG_ANIMACY, animacy));
        }

        public C setMultiplicity(String multiplicity) {
            return (C) ((SemioticClassBuilder) setStringArgument(TtsSpan.ARG_MULTIPLICITY, multiplicity));
        }

        public C setCase(String grammaticalCase) {
            return (C) ((SemioticClassBuilder) setStringArgument(TtsSpan.ARG_CASE, grammaticalCase));
        }
    }
