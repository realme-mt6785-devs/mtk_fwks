                ...
                if (parentMatches(startParent, endParent)) {
                    ...
                    if (!changeBounds.mResizeClip) {
                        ...
                        if (numChanges != 2) {
                            ...
                            return ObjectAnimator.ofObject(view, (Property<View, V>) TOP_LEFT_ONLY_PROPERTY, (TypeConverter) null, topLeftPath);
                            ...
                            return ObjectAnimator.ofObject(view2, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath2);
                        } else {
                            ViewBounds viewBounds = new ViewBounds(view2);
                            Path topLeftPath3 = getPathMotion().getPath(startLeft, startTop2, endLeft2, endTop);
                            ObjectAnimator topLeftAnimator = ObjectAnimator.ofObject(viewBounds, (Property<ViewBounds, V>) TOP_LEFT_PROPERTY, (TypeConverter) null, topLeftPath3);
                        ...
                        if (startLeft == endLeft2 && startTop2 == endTop) {
                            ...
                            positionAnimator = ObjectAnimator.ofObject(view2, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath4);
                        }
                        if (startClip == null) {
                            i = 0;
