...
public final class UpdatableDriverProto {
    ...
    public static final class Denylists extends GeneratedMessageLite<Denylists, Builder> implements DenylistsOrBuilder {
        ...
        private void ensureDenylistsIsMutable() {
            if (!this.denylists_.isModifiable()) {
                this.denylists_ = GeneratedMessageLite.mutableCopy(this.denylists_);
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setDenylists(int index, Denylist.Builder builderForValue) {
            ensureDenylistsIsMutable();
            this.denylists_.set(index, builderForValue.build());
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addDenylists(Denylist.Builder builderForValue) {
            ensureDenylistsIsMutable();
            this.denylists_.add(builderForValue.build());
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void addDenylists(int index, Denylist.Builder builderForValue) {
            ensureDenylistsIsMutable();
            this.denylists_.add(index, builderForValue.build());
        }
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Denylists, Builder> implements DenylistsOrBuilder {
            ...
            public Builder setDenylists(int index, Denylist.Builder builderForValue) {
                copyOnWrite();
                ((Denylists) this.instance).setDenylists(index, builderForValue);
                return this;
            }
            ...
            public Builder addDenylists(Denylist.Builder builderForValue) {
                copyOnWrite();
                ((Denylists) this.instance).addDenylists(builderForValue);
                return this;
            }

            public Builder addDenylists(int index, Denylist.Builder builderForValue) {
                copyOnWrite();
                ((Denylists) this.instance).addDenylists(index, builderForValue);
                return this;
            }
