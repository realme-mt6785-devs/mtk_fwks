...
public final class Log {
    ...
    private static TerribleFailureHandler sWtfHandler = new TerribleFailureHandler() { // from class: android.util.Log.1
        ...
        public void onTerribleFailure(String tag, TerribleFailure what, boolean system2) {
            RuntimeInit.wtf(tag, what, system2);
        }
    };
    ...
    public static int p(String tag, String msg) {
        return println_native(3, 4, tag, msg);
    }
    ...
    public static int wtf(int logId, String tag, String msg, Throwable tr, boolean localStack, boolean system2) {
        TerribleFailure what = new TerribleFailure(msg, tr);
        int bytes = printlns(logId, 6, tag, msg, localStack ? what : tr);
        sWtfHandler.onTerribleFailure(tag, what, system2);
        return bytes;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void wtfQuiet(int logId, String tag, String msg, boolean system2) {
