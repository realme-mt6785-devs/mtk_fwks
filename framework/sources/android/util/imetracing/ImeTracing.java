...
public abstract class ImeTracing {
    ...
    public abstract void triggerClientDump(String str, InputMethodManager inputMethodManager, ProtoOutputStream protoOutputStream);

    public abstract void triggerManagerServiceDump(String str);

    public abstract void triggerServiceDump(String str, AbstractInputMethodService abstractInputMethodService, ProtoOutputStream protoOutputStream);
