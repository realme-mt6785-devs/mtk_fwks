...
public final class DisplayInfo implements Parcelable {
    ...
    public DisplayInfo() {
        ...
        this.removeMode = 0;
        this.mDisplayInfoExt = DisplayInfoExtPlugin.constructor.newInstance();
    }
    ...
    private void getMetricsWithSize(DisplayMetrics outMetrics, CompatibilityInfo compatInfo, Configuration configuration, int width, int height) {
        ...
        IDisplayInfoExt iDisplayInfoExt = this.mDisplayInfoExt;
        if (iDisplayInfoExt != null && configuration == null && iDisplayInfoExt.supportDisplayCompat()) {
            this.mDisplayInfoExt.overrideDisplayMetricsIfNeed(outMetrics);
