...
public class InsetsState implements Parcelable {
    ...
    private boolean mIsFormInsetsAnimation;
    ...
    public InsetsState() {
        ...
        this.mIsFormInsetsAnimation = false;
    }
    ...
    public InsetsState(InsetsState copy, boolean copySources, boolean isFormInsetsAnimation) {
        this.mSources = new InsetsSource[22];
        this.mDisplayFrame = new Rect();
        this.mDisplayCutout = new DisplayCutout.ParcelableWrapper();
        this.mRoundedCorners = RoundedCorners.NO_ROUNDED_CORNERS;
        this.mPrivacyIndicatorBounds = new PrivacyIndicatorBounds();
        this.mIsFormInsetsAnimation = false;
        this.mIsFormInsetsAnimation = isFormInsetsAnimation;
        set(copy, copySources);
    }
    ...
    public void set(InsetsState other, boolean copySources) {
        ...
        if (copySources) {
            for (int i = 0; i < 22; i++) {
                ...
                this.mSources[i] = source != null ? new InsetsSource(source, this.mIsFormInsetsAnimation) : null;
            }
            return;
        }
