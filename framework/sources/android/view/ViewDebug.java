        ...
        for (PropertyInfo<ExportedProperty, ?> info : getExportedProperties(klass)) {
            ...
            if (info.returnType != Integer.TYPE && info.returnType != Byte.TYPE) {
                if (info.returnType == int[].class) {
                    ...
                    exportUnrolledArray(context, out, info.property, (int[]) value, valuePrefix, info.entrySuffix);
                } else if (info.returnType == String[].class) {
                    String[] array = (String[]) value;
                    if (info.property.hasAdjacentMapping() && array != null) {
                        for (int j = 0; j < array.length; j += 2) {
                            if (array[j] != null) {
                                writeEntry(out, categoryPrefix + prefix, array[j], info.entrySuffix, array[j + 1] == null ? "null" : array[j + 1]);
                            }
                        }
                    }
            ...
            } else if (info.property.resolveId() && context != null) {
                ...
                if (flagsMapping.length > 0) {
                    ...
                    exportUnrolledFlags(out, flagsMapping, ((Integer) value).intValue(), valuePrefix2);
                }
            ...
            } else if (info.returnType == Integer.TYPE) {
