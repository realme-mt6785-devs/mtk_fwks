...
public class DatePickerCalendarDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        View.OnClickListener datePickerCalendarDelegate$$ExternalSyntheticLambda0 = new View.OnClickListener() { // from class: android.widget.DatePickerCalendarDelegate$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DatePickerCalendarDelegate.this.lambda$new$0$DatePickerCalendarDelegate(view);
            }
        };
        this.mOnHeaderClickListener = datePickerCalendarDelegate$$ExternalSyntheticLambda0;
        ...
        this.mMinDate = instance;
        Calendar instance2 = Calendar.getInstance(locale);
        this.mMaxDate = instance2;
        instance.set(DEFAULT_START_YEAR, 0, 1);
        ...
        textView.setOnClickListener(datePickerCalendarDelegate$$ExternalSyntheticLambda0);
        TextView textView2 = (TextView) header.findViewById(R.id.date_picker_header_date);
        this.mHeaderMonthDay = textView2;
        textView2.setOnClickListener(datePickerCalendarDelegate$$ExternalSyntheticLambda0);
        ...
        this.mDayPickerView.setMinDate(instance.getTimeInMillis());
        this.mDayPickerView.setMaxDate(instance2.getTimeInMillis());
        ...
        yearPickerView.setRange(instance, instance2);
