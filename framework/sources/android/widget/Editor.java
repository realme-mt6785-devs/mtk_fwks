...
public class Editor {
    ...
    private IEditorExt mEditorExt = (IEditorExt) ExtLoader.type(IEditorExt.class).base(this).create();
    ...
    public void prepareCursorControllers() {
        ...
        boolean z = enabled && this.mTextView.textCanBeSelected();
        this.mSelectionControllerEnabled = z;
        boolean[] controllersEnabled = this.mEditorExt.handleCursorControllersEnabled(this.mInsertionControllerEnabled, z);
        boolean z2 = controllersEnabled[0];
        this.mInsertionControllerEnabled = z2;
                ...
                while (true) {
                    ...
                    if (i5 >= indexFirstChangedBlock2 && blockIndex2 != -1) {
                        ...
                        if (textRenderNodeArr2[blockIndex2] != null) {
                            textRenderNodeArr2[blockIndex2].needsToBeShifted = z;
                        }
                    }
    ...
    private int drawHardwareAcceleratedInner(Canvas canvas, Layout layout, Path highlight, Paint highlightPaint, int cursorOffsetVertical, int[] blockEndLines, int[] blockIndices, int blockInfoIndex, int numberOfBlocks, int startIndexToFindAvailableRenderNode) {
        ...
        if (this.mTextRenderNodes[blockIndex].needsToBeShifted || blockDisplayListIsInvalid) {
            if (blockInfoIndex == 0) {
                ...
                blockBeginLine = blockEndLines[blockInfoIndex - 1] + 1;
            }
        ...
        if (!getSelectionActionModeHelper().resetSelection(getTextView().getOffsetForPosition(event.getX(), event.getY()))) {
            ...
            if (!selectAllGotFocus && text.length() > 0) {
                ...
                if (isCursorInsideEasyCorrectionSpan()) {
                    ...
                    Runnable editor$$ExternalSyntheticLambda1 = new Runnable() { // from class: android.widget.Editor$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Editor.this.replace();
                        }
                    };
                    this.mShowSuggestionRunnable = editor$$ExternalSyntheticLambda1;
                    this.mTextView.postDelayed(editor$$ExternalSyntheticLambda1, ViewConfiguration.getDoubleTapTimeout());
    ...
    public class SuggestionHelper {
        ...
        public int getSuggestionInfo(SuggestionInfo[] suggestionInfos, SuggestionSpanInfo misspelledSpanInfo) {
            ...
            SuggestionInfo otherSuggestionInfo = null;
            if (nbSpans == 0) {
                return 0;
            }
    ...
    public abstract class HandleView extends View implements TextViewPositionListener {
        ...
        /* JADX WARN: Removed duplicated region for block: B:69:0x01f7 A[ADDED_TO_REGION, ORIG_RETURN, RETURN] */
        /*
    ...
    public final class SelectionHandleView extends HandleView {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:124:0x01c9, code lost:
            if (r8 < r23.mPrevLine) goto L_0x01ce;
         */
    ...
    public static final class ProcessTextIntentActionsHandler {
        ...
        private ProcessTextIntentActionsHandler(Editor editor) {
            ...
            this.mInnerEditorExt = (IEditorExt) ExtLoader.type(IEditorExt.class).base(null).create();
        ...
        public void onInitializeMenu(Menu menu) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!this.mInnerEditorExt.setSearchMenuItem(i + 100, createProcessTextIntentForResolveInfo(resolveInfo), getLabel(resolveInfo), resolveInfo, menu)) {
