...
public class RelativeLayout extends ViewGroup {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSize2 = 0;
        int width3 = width;
        while (heightSize2 < count2) {
            View child2 = views2[heightSize2];
            if (child2.getVisibility() != 8) {
                ...
                if (!isWrapContentWidth) {
                    ...
                    width3 = Math.max(width3, (myWidth - params2.mLeft) + myHeight3);
                }
                if (isWrapContentHeight2) {
                    height2 = targetSdkVersion < 19 ? Math.max(height2, params2.mBottom) : Math.max(height2, params2.mBottom + params2.bottomMargin);
                }
                ...
                if (child2 != ignore2 || horizontalGravity) {
                    ...
                    int top2 = params2.bottomMargin;
                    bottom = Math.max(bottom, right3 + top2);
                    right = right2;
                    top = top;
                }
            } else {
        ...
        while (targetSdkVersion2 < count3) {
            View child3 = views2[targetSdkVersion2];
        ...
        if (horizontalGravity || verticalGravity) {
            ...
            if (horizontalOffset != 0 || verticalOffset != 0) {
                int i5 = 0;
                while (i5 < count3) {
                    View child6 = views2[i5];
                    int bottom3 = child6.getVisibility();
                    if (bottom3 != 8) {
                        ignore = ignore3;
                        if (child6 != ignore) {
