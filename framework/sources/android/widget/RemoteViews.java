...
public class RemoteViews implements Parcelable, LayoutInflater.Filter {
    ...
    public final class ViewContentNavigation extends Action {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x001C: INVOKE_POLYMORPHIC r1, r0, method: android.widget.RemoteViews.ViewContentNavigation.apply(android.view.View, android.view.ViewGroup, android.widget.RemoteViews$InteractionHandler, android.widget.RemoteViews$ColorResources):void
            jadx.core.utils.exceptions.DecodeException: Unknown instruction: '0x001C: INVOKE_POLYMORPHIC r1, r0'
            	...
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:378)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:384)
            	at jadx.core.ProcessClass.process(ProcessClass.java:57)
            	at jadx.core.ProcessClass.generateCode(ProcessClass.java:93)
            	at jadx.core.dex.nodes.ClassNode.decompile(ClassNode.java:358)
            	at jadx.core.dex.nodes.ClassNode.decompile(ClassNode.java:304)
            */
        @Override // android.widget.RemoteViews.Action
    ...
    public class ViewGroupActionAdd extends Action {
        ...
        private Action insertNewView(Context context, ViewTree target, InteractionHandler handler, ColorResources colorResources, final Runnable finalizeAction) {
            ...
            if (tree != null) {
                ...
                final int insertIndex = this.mIndex;
                if (insertIndex < 0) {
                    insertIndex = nextChild;
                }
    ...
    private RemoteViews(Parcel parcel, BitmapCache bitmapCache, ApplicationInfo info, int depth, Map<Class, Object> classCookies) {
        ...
        if (depth <= 10 || UserHandle.getAppId(Binder.getCallingUid()) == 1000) {
            ...
            if (mode == 0) {
                ...
                this.mIdealSize = parcel.readInt() != 0 ? SizeF.CREATOR.createFromParcel(parcel) : sizeF;
                ...
                RemoteViews remoteViews2 = new RemoteViews(parcel, this.mBitmapCache, this.mLandscape.mApplication, depth2, this.mClassCookies);
    ...
    private RemoteViews findBestFitLayout(SizeF widgetSize) {
        ...
        for (RemoteViews layout : this.mSizedRemoteViews) {
            ...
            if (layoutSize == null) {
                throw new IllegalStateException("Expected RemoteViews to have ideal size");
            } else if (fitsIn(layoutSize, widgetSize)) {
                if (bestFit == null) {
                    bestFit = layout;
    ...
    public static final class RemoteCollectionItems implements Parcelable {
        ...
        public static final class Builder {
            ...
            public Builder addItem(long id, RemoteViews view) {
                ...
                } else if (!view.hasMultipleLayouts()) {
                    this.mIds.add(id);
