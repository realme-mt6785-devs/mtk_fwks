...
public class Scroller {
    ...
    private ScrollScenario mScenario;
    ...
    public Scroller(Context context, Interpolator interpolator, boolean flywheel) {
        ...
        this.mFinished = true;
        this.mScenario = new ScrollScenario(1, 3, 0, context);
    ...
    public void startScroll(int startX, int startY, int dx, int dy, int duration) {
        ...
        if (duration != 0) {
            BoostFwkFactory.getInstance().makeBoostFwkManager().perfHint(this.mScenario);
        }
    }
