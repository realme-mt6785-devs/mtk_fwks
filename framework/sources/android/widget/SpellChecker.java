...
public class SpellChecker implements SpellCheckerSession.SpellCheckerSessionListener {
            ...
            while (true) {
                ...
                if (this.mIds[i] >= 0 && !spellCheckSpan.isSpellCheckInProgress()) {
                    ...
                    if (selectionStart == end + 1 && WordIterator.isMidWordPunctuation(this.mCurrentLocale, Character.codePointBefore(editable, end + 1))) {
                        ...
                        isNotEditing = true;
                    } else if (selectionStart == end && selectionStart > 0 && isSeparator(Character.codePointBefore(editable, selectionStart))) {
                        isNotEditing = true;
                    }
    ...
    public class SpellParser {
        ...
        public void parse() {
            ...
            if (!scheduleOtherSpellCheck || spellCheckEnd == -1 || spellCheckEnd > textChangeEnd) {
                removeRangeSpan(editable);
            } else {
                setRangeSpan(editable, spellCheckEnd, textChangeEnd);
            }
