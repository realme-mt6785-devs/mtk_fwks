    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || Android.isOnAndroidDevice() || spaceLeft() < 5) {
                ...
                this.position = i3 + 1;
                UnsafeUtil.putByte(bArr3, i3, (byte) value);
            } else {
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
                this.position = i4 + 1;
                UnsafeUtil.putByte(bArr4, i4, (byte) (value | 128));
                int value2 = value >>> 7;
                if ((value2 & (-128)) == 0) {
                    byte[] bArr5 = this.buffer;
                    int i5 = this.position;
                    this.position = i5 + 1;
                    UnsafeUtil.putByte(bArr5, i5, (byte) value2);
                    return;
                }
                byte[] bArr6 = this.buffer;
                int i6 = this.position;
                this.position = i6 + 1;
                UnsafeUtil.putByte(bArr6, i6, (byte) (value2 | 128));
                int value3 = value2 >>> 7;
                if ((value3 & (-128)) == 0) {
                    byte[] bArr7 = this.buffer;
                    int i7 = this.position;
                    this.position = i7 + 1;
                    UnsafeUtil.putByte(bArr7, i7, (byte) value3);
                    return;
                }
                byte[] bArr8 = this.buffer;
                int i8 = this.position;
                this.position = i8 + 1;
                UnsafeUtil.putByte(bArr8, i8, (byte) (value3 | 128));
                int value4 = value3 >>> 7;
                if ((value4 & (-128)) == 0) {
                    byte[] bArr9 = this.buffer;
                    int i9 = this.position;
                    this.position = i9 + 1;
                    UnsafeUtil.putByte(bArr9, i9, (byte) value4);
                    return;
                }
                byte[] bArr10 = this.buffer;
                int i10 = this.position;
                this.position = i10 + 1;
                UnsafeUtil.putByte(bArr10, i10, (byte) (value4 | 128));
                byte[] bArr11 = this.buffer;
                int i11 = this.position;
                this.position = i11 + 1;
                UnsafeUtil.putByte(bArr11, i11, (byte) (value4 >>> 7));
            }
        }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            ...
            while ((value & (-128)) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                UnsafeUtil.putByte(bArr3, i3, (byte) ((((int) value) & 127) | 128));
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i4 = this.position;
            this.position = i4 + 1;
            UnsafeUtil.putByte(bArr4, i4, (byte) value);
        }
