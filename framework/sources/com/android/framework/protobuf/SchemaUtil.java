...
public final class SchemaUtil {
    ...
    public static int computeSizeStringList(int fieldNumber, List<?> list) {
        ...
        if (list instanceof LazyStringList) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                Object value2 = list.get(i4);
                if (value2 instanceof ByteString) {
                    i = CodedOutputStream.computeBytesSizeNoTag((ByteString) value2);
                } else {
                    i = CodedOutputStream.computeStringSizeNoTag((String) value2);
                }
                size += i;
            }
        }
    ...
    static int computeSizeMessageList(int fieldNumber, List<?> list) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (value instanceof LazyFieldLite) {
                i = CodedOutputStream.computeLazyFieldSizeNoTag((LazyFieldLite) value);
            } else {
                i = CodedOutputStream.computeMessageSizeNoTag((MessageLite) value);
            }
            size += i;
        }
        return size;
    ...
    public static int computeSizeMessageList(int fieldNumber, List<?> list, Schema schema) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (value instanceof LazyFieldLite) {
                ...
                i = CodedOutputStream.computeMessageSizeNoTag((MessageLite) value, schema);
            }
            size += i;
        }
        return size;
