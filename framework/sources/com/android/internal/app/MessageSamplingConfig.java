...
public final class MessageSamplingConfig implements Parcelable {
    ...
    private static final int _NUM_OP = 120;
    ...
    public MessageSamplingConfig(int sampledOpCode, int acceptableLeftDistance, long expirationTimeSinceBootMillis) {
        ...
        AnnotationValidations.validate((Class<IntRange>) IntRange.class, (IntRange) null, sampledOpCode, "from", -1L, "to", 119L);
        this.mAcceptableLeftDistance = acceptableLeftDistance;
        AnnotationValidations.validate((Class<IntRange>) IntRange.class, (IntRange) null, acceptableLeftDistance, "from", 0L, "to", 119L);
