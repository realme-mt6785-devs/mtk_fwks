...
public class DisplayResolveInfo implements TargetInfo, Parcelable {
    ...
    public DisplayResolveInfo(Intent originalIntent, ResolveInfo pri, CharSequence pLabel, CharSequence pInfo, Intent resolvedIntent, ResolverListAdapter.ResolveInfoPresentationGetter resolveInfoPresentationGetter) {
        ...
        boolean z = false;
        this.mPinned = false;
        this.mDisplayResolveInfoExt = DisplayResolveInfoExtPlugin.constructor.newInstance();
    ...
    public boolean startAsCaller(ResolverActivity activity, Bundle options, int userId) {
        activity.startActivityAsCaller(this.mResolvedIntent, options, null, false, this.mDisplayResolveInfoExt.changeUserIdIfNeed(activity.mResolverActivityExt, this.mResolvedIntent, userId));
        return true;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        List<Intent> list = this.mSourceIntents;
        dest.writeParcelableArray((Intent[]) list.toArray(new Intent[list.size()]), 0);
