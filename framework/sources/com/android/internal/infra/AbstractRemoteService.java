...
public abstract class AbstractRemoteService<S extends AbstractRemoteService<S, I>, I extends IInterface> implements IBinder.DeathRecipient {
    ...
    public static abstract class PendingRequest<S extends AbstractRemoteService<S, I>, I extends IInterface> extends BasePendingRequest<S, I> {
        ...
        protected PendingRequest(final S service) {
            ...
            Runnable abstractRemoteService$PendingRequest$$ExternalSyntheticLambda0 = new Runnable() { // from class: com.android.internal.infra.AbstractRemoteService$PendingRequest$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AbstractRemoteService.PendingRequest.this.lambda$new$0$AbstractRemoteService$PendingRequest(service);
                }
            };
            this.mTimeoutTrigger = abstractRemoteService$PendingRequest$$ExternalSyntheticLambda0;
            handler.postAtTime(abstractRemoteService$PendingRequest$$ExternalSyntheticLambda0, SystemClock.uptimeMillis() + service.getRemoteRequestMillis());
        }
