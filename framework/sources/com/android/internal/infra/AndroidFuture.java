...
public class AndroidFuture<T> extends CompletableFuture<T> implements Parcelable {
    ...
    public static class ThenComposeAsync<T, U> extends AndroidFuture<U> implements BiConsumer<Object, Throwable>, Runnable {
        ...
        public void run() {
            try {
                CompletionStage<U> secondJob = (CompletionStage) Preconditions.checkNotNull((CompletionStage) this.mFn.apply((T) this.mSourceResult));
                this.mFn = null;
    ...
    public AndroidFuture<T> thenCombine(CompletionStage<Void> other) {
        return (AndroidFuture<T>) thenCombine((CompletionStage) other, (BiFunction) AndroidFuture$$ExternalSyntheticLambda3.INSTANCE);
    }
