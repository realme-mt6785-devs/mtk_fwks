...
public interface BCObjectIdentifiers {
    ...
    static {
        ...
        bc_pbe = branch;
        ASN1ObjectIdentifier branch2 = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        bc_pbe_sha1 = branch2;
        ...
        bc_pbe_sha1_pkcs5 = branch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch4 = branch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        bc_pbe_sha1_pkcs12 = branch4;
        bc_pbe_sha256_pkcs5 = branch3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch5 = branch3.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ...
        ASN1ObjectIdentifier branch6 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        bc_sig = branch6;
        ASN1ObjectIdentifier branch7 = branch6.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        xmss = branch7;
        ASN1ObjectIdentifier branch8 = branch7.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        xmss_SHA256ph = branch8;
        ASN1ObjectIdentifier branch9 = branch7.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        xmss_SHA512ph = branch9;
        ASN1ObjectIdentifier branch10 = branch7.branch("3");
        xmss_SHAKE128ph = branch10;
        ASN1ObjectIdentifier branch11 = branch7.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        xmss_mt = branch12;
        ASN1ObjectIdentifier branch13 = branch12.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        xmss_mt_SHA256ph = branch13;
        ASN1ObjectIdentifier branch14 = branch12.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        xmss_mt_SHA512ph = branch14;
        xmss_mt_SHAKE128ph = branch12.branch("3");
        xmss_mt_SHAKE256ph = branch12.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        ASN1ObjectIdentifier branch17 = branch6.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        qTESLA = branch17;
        qTESLA_Rnd1_I = branch17.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        qTESLA_Rnd1_III_size = branch17.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        qTESLA_Rnd1_III_speed = branch17.branch("3");
        qTESLA_Rnd1_p_I = branch17.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        qTESLA_Rnd1_p_III = branch17.branch("5");
        qTESLA_p_I = branch17.branch("11");
        qTESLA_p_III = branch17.branch("12");
        ASN1ObjectIdentifier branch18 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        bc_ext = branch18;
        linkedCertificate = branch18.branch(IOplusUIFirstManager.APP_START_ANIMATION);
    }
}
