...
public interface CMSObjectIdentifiers {
    ...
    static {
        ...
        id_ri_ocsp_response = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_ri_scvp = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
    }
}
