...
public interface EACObjectIdentifiers {
    ...
    static {
        ...
        id_PK = branch;
        id_PK_DH = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_PK_ECDH = branch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("2.2.3");
        id_CA = branch2;
        ASN1ObjectIdentifier branch3 = branch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_CA_DH = branch3;
        id_CA_DH_3DES_CBC_CBC = branch3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch4 = branch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_CA_ECDH = branch4;
        id_CA_ECDH_3DES_CBC_CBC = branch4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch5 = aSN1ObjectIdentifier.branch("2.2.2");
        id_TA = branch5;
        ASN1ObjectIdentifier branch6 = branch5.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_TA_RSA = branch6;
        id_TA_RSA_v1_5_SHA_1 = branch6.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_TA_RSA_v1_5_SHA_256 = branch6.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_TA_RSA_PSS_SHA_1 = branch6.branch("3");
        id_TA_RSA_PSS_SHA_256 = branch6.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        id_TA_RSA_v1_5_SHA_512 = branch6.branch("5");
        id_TA_RSA_PSS_SHA_512 = branch6.branch("6");
        ASN1ObjectIdentifier branch7 = branch5.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_TA_ECDSA = branch7;
        id_TA_ECDSA_SHA_1 = branch7.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_TA_ECDSA_SHA_224 = branch7.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_TA_ECDSA_SHA_256 = branch7.branch("3");
        id_TA_ECDSA_SHA_384 = branch7.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
