...
public interface GMObjectIdentifiers {
    ...
    static {
        ...
        sm2encrypt_recommendedParameters = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        sm2encrypt_specifiedParameters = branch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ...
        sm3 = branch2;
        hmac_sm3 = branch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
