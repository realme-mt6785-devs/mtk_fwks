...
public interface IANAObjectIdentifiers {
    ...
    static {
        ...
        directory = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        mgmt = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        experimental = aSN1ObjectIdentifier.branch("3");
        _private = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        hmacMD5 = branch4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        hmacSHA1 = branch4.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        hmacTIGER = branch4.branch("3");
        hmacRIPEMD160 = branch4.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
    }
}
