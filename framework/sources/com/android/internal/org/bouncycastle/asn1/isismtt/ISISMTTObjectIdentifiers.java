...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_isismtt_cp = branch;
        id_isismtt_cp_accredited = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("3");
        id_isismtt_at = branch2;
        id_isismtt_at_dateOfCertGen = branch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_isismtt_at_procuration = branch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_isismtt_at_admission = branch2.branch("3");
        id_isismtt_at_monetaryLimit = branch2.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
