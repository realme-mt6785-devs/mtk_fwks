...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        netscapeCertType = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        netscapeBaseURL = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        netscapeRevocationURL = aSN1ObjectIdentifier.branch("3");
        netscapeCARevocationURL = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier5.branch(IOplusUIFirstManager.APP_START_ANIMATION);
