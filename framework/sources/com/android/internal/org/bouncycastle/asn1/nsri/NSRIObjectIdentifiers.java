...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_sea = branch2;
        id_pad = branch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_pad_null = branch.branch("0");
        id_pad_1 = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_aria128_ecb = branch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_aria128_cbc = branch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_aria128_cfb = branch2.branch("3");
        id_aria128_ofb = branch2.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
