...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        rsaEncryption = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        md5WithRSAEncryption = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        dhKeyAgreement = aSN1ObjectIdentifier2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier aSN1ObjectIdentifier3 = new ASN1ObjectIdentifier("1.2.840.113549.1.5");
        pkcs_5 = aSN1ObjectIdentifier3;
        pbeWithMD2AndDES_CBC = aSN1ObjectIdentifier3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        pbeWithMD2AndRC2_CBC = aSN1ObjectIdentifier3.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        RC2_CBC = aSN1ObjectIdentifier4.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        rc4 = aSN1ObjectIdentifier4.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        pkcs_9_at_emailAddress = aSN1ObjectIdentifier6.branch(IOplusUIFirstManager.APP_START_ANIMATION).intern();
        pkcs_9_at_unstructuredName = aSN1ObjectIdentifier6.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION).intern();
        pkcs_9_at_contentType = aSN1ObjectIdentifier6.branch("3").intern();
        pkcs_9_at_messageDigest = aSN1ObjectIdentifier6.branch(IOplusUIFirstManager.LAUNCHER_SI_START).intern();
        ...
        certTypes = branch;
        x509Certificate = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION).intern();
        sdsiCertificate = branch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION).intern();
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier6.branch("23");
        crlTypes = branch2;
        x509Crl = branch2.branch(IOplusUIFirstManager.APP_START_ANIMATION).intern();
        ...
        id_ct_authData = aSN1ObjectIdentifier7.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_ct_TSTInfo = aSN1ObjectIdentifier7.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        id_cti_ets_proofOfOrigin = aSN1ObjectIdentifier8.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_cti_ets_proofOfReceipt = aSN1ObjectIdentifier8.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_cti_ets_proofOfDelivery = aSN1ObjectIdentifier8.branch("3");
        id_cti_ets_proofOfSender = aSN1ObjectIdentifier8.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        id_aa_receiptRequest = aSN1ObjectIdentifier9.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_aa_contentHint = aSN1ObjectIdentifier9.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        bagtypes = branch8;
        keyBag = branch8.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        pkcs8ShroudedKeyBag = branch8.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        certBag = branch8.branch("3");
        crlBag = branch8.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        secretBag = branch8.branch("5");
        safeContentsBag = branch8.branch("6");
        ASN1ObjectIdentifier branch9 = aSN1ObjectIdentifier10.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        pkcs_12PbeIds = branch9;
        pbeWithSHAAnd128BitRC4 = branch9.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        pbeWithSHAAnd40BitRC4 = branch9.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        pbeWithSHAAnd3_KeyTripleDES_CBC = branch9.branch("3");
        pbeWithSHAAnd2_KeyTripleDES_CBC = branch9.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
