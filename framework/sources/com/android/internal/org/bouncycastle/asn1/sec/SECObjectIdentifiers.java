...
public interface SECObjectIdentifiers {
    ...
    static {
        ...
        sect163k1 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        sect163r1 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        sect239k1 = aSN1ObjectIdentifier.branch("3");
        sect113r1 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
