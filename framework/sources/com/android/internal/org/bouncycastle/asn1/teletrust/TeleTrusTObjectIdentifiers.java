...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        rsaSignatureWithripemd160 = branch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        rsaSignatureWithripemd128 = branch.branch("3");
        rsaSignatureWithripemd256 = branch.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("3.2");
        ecSign = branch2;
        ecSignWithSha1 = branch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ecSignWithRipemd160 = branch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ASN1ObjectIdentifier branch3 = aSN1ObjectIdentifier.branch("3.2.8");
        ecc_brainpool = branch3;
        ASN1ObjectIdentifier branch4 = branch3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ellipticCurve = branch4;
        ASN1ObjectIdentifier branch5 = branch4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        versionOne = branch5;
        brainpoolP160r1 = branch5.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        brainpoolP160t1 = branch5.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        brainpoolP192r1 = branch5.branch("3");
        brainpoolP192t1 = branch5.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
