...
public class KeyPurposeId extends ASN1Object {
    ...
    static {
        ...
        id_kp_serverAuth = new KeyPurposeId(aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION));
        id_kp_clientAuth = new KeyPurposeId(aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION));
        id_kp_codeSigning = new KeyPurposeId(aSN1ObjectIdentifier.branch("3"));
        id_kp_emailProtection = new KeyPurposeId(aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START));
