...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private static boolean withinDNSubtree(ASN1Sequence dns, ASN1Sequence subtree) {
        ...
        for (int j3 = 0; j3 < subtree.size(); j3++) {
            ...
            } else if (!dnsRdn.getFirst().getValue().toString().startsWith(subtreeRdn.getFirst().getValue().toString())) {
                return false;
            }
        }
        return true;
    ...
    */
    private void checkPermittedDNS(java.util.Set r4, java.lang.String r5) throws com.android.internal.org.bouncycastle.asn1.x509.NameConstraintValidatorException {
        /*
            r3 = this;
        ...
        L_0x0022:
            ...
            return
        L_0x002f:
            com.android.internal.org.bouncycastle.asn1.x509.NameConstraintValidatorException r1 = new com.android.internal.org.bouncycastle.asn1.x509.NameConstraintValidatorException
            java.lang.String r2 = "DNS is not from a permitted subtree."
            r1.<init>(r2)
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.org.bouncycastle.asn1.x509.PKIXNameConstraintValidator.checkPermittedDNS(java.util.Set, java.lang.String):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void checkExcludedDNS(java.util.Set r5, java.lang.String r6) throws com.android.internal.org.bouncycastle.asn1.x509.NameConstraintValidatorException {
        /*
            r4 = this;
        ...
        L_0x000b:
            ...
            goto L_0x000b
        L_0x0024:
            com.android.internal.org.bouncycastle.asn1.x509.NameConstraintValidatorException r2 = new com.android.internal.org.bouncycastle.asn1.x509.NameConstraintValidatorException
        ...
        L_0x002c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.org.bouncycastle.asn1.x509.PKIXNameConstraintValidator.checkExcludedDNS(java.util.Set, java.lang.String):void");
    }
