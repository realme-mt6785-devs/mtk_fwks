...
public interface X509ObjectIdentifiers {
    ...
    static {
        ...
        id_pe = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch("48");
        id_ad = branch;
        ASN1ObjectIdentifier intern = branch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION).intern();
        id_ad_caIssuers = intern;
        ASN1ObjectIdentifier intern2 = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION).intern();
        id_ad_ocsp = intern2;
