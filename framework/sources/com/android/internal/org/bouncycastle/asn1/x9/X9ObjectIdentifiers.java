...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        id_fieldType = branch;
        prime_field = branch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch2 = branch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        characteristic_two_field = branch2;
        gnBasis = branch2.branch("3.1");
        tpBasis = branch2.branch("3.2");
        ppBasis = branch2.branch("3.3");
        ASN1ObjectIdentifier branch3 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        id_ecSigType = branch3;
        ecdsa_with_SHA1 = branch3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch4 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_publicKeyType = branch4;
        id_ecPublicKey = branch4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier branch5 = branch3.branch("3");
        ecdsa_with_SHA2 = branch5;
        ecdsa_with_SHA224 = branch5.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ecdsa_with_SHA256 = branch5.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ecdsa_with_SHA384 = branch5.branch("3");
        ecdsa_with_SHA512 = branch5.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        cTwoCurve = branch7;
        c2pnb163v1 = branch7.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        c2pnb163v2 = branch7.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        c2pnb163v3 = branch7.branch("3");
        c2pnb176w1 = branch7.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        ASN1ObjectIdentifier branch8 = branch6.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        primeCurve = branch8;
        prime192v1 = branch8.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        prime192v2 = branch8.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        prime192v3 = branch8.branch("3");
        prime239v1 = branch8.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        dhSinglePass_stdDH_sha1kdf_scheme = aSN1ObjectIdentifier2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ...
        dhStatic = branch9.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        dhEphem = branch9.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        dhOneFlow = branch9.branch("3");
        dhHybrid1 = branch9.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        ASN1ObjectIdentifier branch10 = aSN1ObjectIdentifier4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        x9_44_components = branch10;
        id_kdf_kdf2 = branch10.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_kdf_kdf3 = branch10.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
    }
}
