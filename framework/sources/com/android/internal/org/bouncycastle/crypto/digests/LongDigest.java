...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    protected void processBlock() {
        ...
        while (i < 10) {
            long[] jArr3 = K;
            int t3 = t2 + 1;
            long h2 = e3 + Sum1(e2) + Ch(e2, f2, g2) + jArr3[t2] + this.W[t2];
            long d3 = d2 + h2;
            long h3 = h2 + Sum0(b2) + Maj(b2, g3, h);
            int t4 = t3 + 1;
            long g4 = g2 + Sum1(d3) + Ch(d3, e2, f2) + jArr3[t3] + this.W[t3];
            long c2 = h + g4;
            long g5 = g4 + Sum0(h3) + Maj(h3, b2, g3);
            int t5 = t4 + 1;
            long f3 = f2 + Sum1(c2) + Ch(c2, d3, e2) + jArr3[t4] + this.W[t4];
            long b3 = g3 + f3;
            long f4 = f3 + Sum0(g5) + Maj(g5, h3, b2);
            int t6 = t5 + 1;
            long e4 = e2 + Sum1(b3) + Ch(b3, c2, d3) + jArr3[t5] + this.W[t5];
            long a3 = b2 + e4;
            long e5 = e4 + Sum0(f4) + Maj(f4, g5, h3);
            long e6 = Sum1(a3);
            int t7 = t6 + 1;
            long d4 = d3 + e6 + Ch(a3, b3, c2) + jArr3[t6] + this.W[t6];
            long h4 = h3 + d4;
            long d5 = d4 + Sum0(e5) + Maj(e5, f4, g5);
            long d6 = Sum1(h4);
            int t8 = t7 + 1;
            long c3 = c2 + d6 + Ch(h4, a3, b3) + jArr3[t7] + this.W[t7];
            long g6 = g5 + c3;
            long c4 = c3 + Sum0(d5) + Maj(d5, e5, f4);
            long c5 = Sum1(g6);
            h = c4;
            int t9 = t8 + 1;
            long b4 = b3 + c5 + Ch(g6, h4, a3) + jArr3[t8] + this.W[t8];
            long f5 = f4 + b4;
            long b5 = b4 + Sum0(h) + Maj(h, d5, e5);
            long b6 = Sum1(f5);
            int t10 = t9 + 1;
            long a4 = a3 + b6 + Ch(f5, g6, h4) + jArr3[t9] + this.W[t9];
            long a5 = a4 + Sum0(b5) + Maj(b5, h, d5);
            i++;
            e2 = e5 + a4;
            g2 = g6;
            t2 = t10;
