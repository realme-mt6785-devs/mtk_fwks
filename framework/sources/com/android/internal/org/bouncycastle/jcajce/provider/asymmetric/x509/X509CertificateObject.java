    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof X509CertificateObject) {
            ...
            if (!this.hashValueSet || !otherBC.hashValueSet) {
                if ((this.internalCertificateValue == null || otherBC.internalCertificateValue == null) && (signature = this.c.getSignature()) != null && !signature.equals(otherBC.c.getSignature())) {
                    return false;
                }
            } else if (this.hashValue != otherBC.hashValue) {
                return false;
            }
        }
