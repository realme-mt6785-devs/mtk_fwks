            ...
            switch (coord) {
                ...
                case 1:
                    ...
                    if (!v.isZero()) {
                        ...
                        return new Fp(curve, X32, Y34, new ECFieldElement[]{vCubed.multiply(w)});
                    } else if (u.isZero()) {
                        return twice();
                    } else {
                        return curve.getInfinity();
                ...
                case 4:
                    ...
                    if (Z1IsOne2 || !Z12.equals(Z22)) {
                        ...
                        if (!H.isZero()) {
                            ...
                            Y1 = R.square().add(G).subtract(two(V));
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            switch (coord) {
                ...
                case 1:
                    ...
                    if (!Z3.isOne()) {
                        ECFieldElement Z23 = Z3.square();
                        ECFieldElement Z32 = Z3.multiply(Z23);
            ...
            switch (coord) {
                ...
                case 1:
                    ...
                    if (!V.isZero()) {
                        ...
                        return new F2m(curve, X34, Y32, new ECFieldElement[]{Z3});
                    } else if (U.isZero()) {
                        return twice();
                    } else {
                        return curve.getInfinity();
                    ...
                    if (!X1.isZero()) {
                        ...
                        if (!B.isZero()) {
                            if (X2.isZero()) {
                                ...
                                X32 = Y23.add(L4).add(X12).add(curve.getA());
                                if (X32.isZero()) {
                                    return new F2m(curve, X32, curve.getB().sqrt());
                                }
                                ECFieldElement Y33 = L4.multiply(X12.add(X32)).add(X32).add(Y13);
                                X3 = Y33.divide(X32).add(X32);
                                ...
                                if (!Z1IsOne) {
                                    ECFieldElement Z32 = ABZ2.multiply(Z12);
                                    X32 = X35;
                                    X3 = L32;
                                    L3 = Z32;
                                } else {
                            ...
                            return new F2m(curve, X32, X3, new ECFieldElement[]{L3});
                        } else if (A2.isZero()) {
                            return twice();
                        } else {
                            return curve.getInfinity();
        ...
        public ECPoint twice() {
            ...
            switch (coord) {
                ...
                case 1:
                    ...
                    return new F2m(curve, X32, Y32, new ECFieldElement[]{X1Z1.multiply(vSquared)});
                case 6:
