...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        int[] H = Nat.create(17);
        SecP521R1Field.subtract(S1, U2, H);
        SecP521R1Field.subtract(U1, S2, t2);
        if (!Nat.isZero(17, H)) {
            SecP521R1Field.square(H, t3);
            int[] G = Nat.create(17);
            SecP521R1Field.multiply(t3, H, G);
            SecP521R1Field.multiply(t3, S1, t3);
            SecP521R1Field.multiply(U1, G, t1);
            ...
            if (!Z1IsOne) {
                ...
                int[] H2 = Z1.x;
                int[] R = Z3.x;
                SecP521R1Field.multiply(iArr, H2, R);
            }
            if (!Z2IsOne) {
