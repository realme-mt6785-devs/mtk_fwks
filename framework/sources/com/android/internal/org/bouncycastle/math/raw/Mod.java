...
public abstract class Mod {
    ...
    private static void updateDE30(int len30, int[] D, int[] E, int[] t, int m0Inv32, int[] M) {
        ...
        while (i < len30) {
            ...
            long ce3 = ce2 + (di2 * di3) + (r * ei2) + (mi2 * me2);
            D[i - 1] = ((int) cd3) & 1073741823;
            cd2 = cd3 >> 30;
            E[i - 1] = ((int) ce3) & 1073741823;
            ce2 = ce3 >> 30;
            i++;
            di2 = di2;
            q = q;
    ...
    private static void updateFG30(int len30, int[] F, int[] G, int[] t) {
        ...
        while (i < len30) {
            ...
            F[i - 1] = ((int) cf3) & 1073741823;
            cf2 = cf3 >> 30;
            G[i - 1] = 1073741823 & ((int) cg3);
            cg2 = cg3 >> 30;
            i++;
            u = u;
            v = v;
