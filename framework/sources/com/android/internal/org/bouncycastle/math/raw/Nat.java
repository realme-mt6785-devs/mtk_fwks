...
public abstract class Nat {
    ...
    */
    public static int dec(int r3, int[] r4, int[] r5) {
        /*
            r0 = 0
        L_0x0001:
            r1 = -1
        ...
        L_0x001a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.org.bouncycastle.math.raw.Nat.dec(int, int[], int[]):int");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static int inc(int r3, int[] r4, int[] r5) {
        /*
            r0 = 0
        L_0x0001:
            r1 = 1
        ...
        L_0x0019:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.org.bouncycastle.math.raw.Nat.inc(int, int[], int[]):int");
    }
