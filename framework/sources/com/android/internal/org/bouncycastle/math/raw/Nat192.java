...
public abstract class Nat192 {
    ...
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        for (int i2 = 6; i < i2; i2 = 6) {
            ...
            zz[i + 3] = (int) c10;
            long c11 = (c10 >>> 32) + (x_i * y_4) + (zz[i + 4] & 4294967295L);
            zz[i + 4] = (int) c11;
            long c12 = (c11 >>> 32) + (x_i * y_5) + (zz[i + 5] & 4294967295L);
            zz[i + 5] = (int) c12;
            zz[i + 6] = (int) (c12 >>> 32);
            i++;
            y_1 = y_1;
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        while (i < 6) {
            ...
            zz[i + 4] = (int) c5;
            long c6 = (c5 >>> 32) + (x_i2 * y_5) + (zz[i + 5] & 4294967295L);
            zz[i + 5] = (int) c6;
            long zc = x_i + (zz[i + 6] & 4294967295L) + (c6 >>> 32);
            zz[i + 6] = (int) zc;
            x_i = zc >>> 32;
            i++;
            y_5 = y_5;
