...
public abstract class Nat256 {
    ...
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        for (int i2 = 8; i < i2; i2 = 8) {
            ...
            zz[i + 5] = (int) c14;
            long c15 = (c14 >>> 32) + (x_i * y_6) + (zz[i + 6] & 4294967295L);
            zz[i + 6] = (int) c15;
    ...
    public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        while (i < 8) {
            ...
            int i2 = zz[zzOff2 + 0];
            long c9 = 0 + (x_i * y_0) + (i2 & 4294967295L);
            zz[zzOff2 + 0] = (int) c9;
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        while (i < 8) {
            long y_72 = x[i];
            long x_i = y_72 & 4294967295L;
            long j = x_i * y_0;
            long y_02 = zz[i + 0];
            long c = 0 + j + (y_02 & 4294967295L);
            zz[i + 0] = (int) c;
            ...
            zz[i + 4] = (int) c5;
            long c6 = (c5 >>> 32) + (x_i * y_5) + (zz[i + 5] & 4294967295L);
            zz[i + 5] = (int) c6;
            long c7 = (c6 >>> 32) + (x_i * y_6) + (zz[i + 6] & 4294967295L);
            zz[i + 6] = (int) c7;
            long c8 = (c7 >>> 32) + (x_i * y_7) + (zz[i + 7] & 4294967295L);
            zz[i + 7] = (int) c8;
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        while (i < 8) {
            ...
            zz[zzOff2 + 6] = (int) c7;
            long c8 = (c7 >>> 32) + (x_i * y_7) + (zz[zzOff2 + 7] & 4294967295L);
            zz[zzOff2 + 7] = (int) c8;
