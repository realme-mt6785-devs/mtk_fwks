...
public class ZygoteServer {
    ...
    public Runnable fillUsapPool(int[] sessionSocketRawFDs, boolean isPriorityRefill) {
        ...
        if (isPriorityRefill) {
            ...
            int numUsapsToSpawn2 = this.mUsapPoolSizeMax;
            numUsapsToSpawn = numUsapsToSpawn2 - usapPoolCount;
