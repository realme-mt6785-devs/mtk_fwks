...
public class GestureNavigationSettingsObserver extends ContentObserver {
    ...
    private final DeviceConfig.OnPropertiesChangedListener mOnPropertiesChangedListener = new DeviceConfig.OnPropertiesChangedListener() { // from class: com.android.internal.policy.GestureNavigationSettingsObserver.1
    ...
    public void register() {
        ...
        DeviceConfig.addOnPropertiesChangedListener(DeviceConfig.NAMESPACE_SYSTEMUI, new Executor() { // from class: com.android.internal.policy.GestureNavigationSettingsObserver$$ExternalSyntheticLambda0
            ...
            public final void execute(Runnable runnable) {
                GestureNavigationSettingsObserver.this.lambda$register$0$GestureNavigationSettingsObserver(runnable);
            }
        }, this.mOnPropertiesChangedListener);
    }

    public /* synthetic */ void lambda$register$0$GestureNavigationSettingsObserver(Runnable runnable) {
