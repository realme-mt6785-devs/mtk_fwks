...
public class PhoneFallbackEventHandler implements FallbackEventHandler {
    ...
    private IPhoneFallbackEventHandlerExt mPFEHExt = PhoneFallbackEventHandlerExtPlugin.constructor.newInstance(new Object[0]);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        IPhoneFallbackEventHandlerExt iPhoneFallbackEventHandlerExt = this.mPFEHExt;
        String str = TAG;
        iPhoneFallbackEventHandlerExt.inputLog(str, " dispatchKeyEvent  " + event);
    ...
    private void handleVolumeKeyEvent(KeyEvent keyEvent) {
        IPhoneFallbackEventHandlerExt iPhoneFallbackEventHandlerExt = this.mPFEHExt;
        String str = TAG;
        iPhoneFallbackEventHandlerExt.inputLog(str, " MediaSession handleVolumeKeyEvent in PhoneFallbackEventHandler : " + keyEvent);
    ...
    private void handleMediaKeyEvent(KeyEvent keyEvent) {
        IPhoneFallbackEventHandlerExt iPhoneFallbackEventHandlerExt = this.mPFEHExt;
        String str = TAG;
        iPhoneFallbackEventHandlerExt.inputLog(str, " MediaSession handleMediaKeyEvent in PhoneFallbackEventHandler : " + keyEvent);
