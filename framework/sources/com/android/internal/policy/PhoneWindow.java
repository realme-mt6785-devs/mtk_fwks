...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    public IPhoneWindowExt mPhoneWindowExt;
    ...
    public PhoneWindow(Context context) {
        ...
        if (Settings.Global.getInt(context.getContentResolver(), Settings.Global.DEVELOPMENT_RENDER_SHADOWS_IN_COMPOSITOR, 1) != 0) {
            z = true;
        } else {
            z = false;
        }
        this.mRenderShadowsInCompositor = z;
        this.mPhoneWindowExt = PhoneWindowExtPlugin.constructor.newInstance(this, context);
    }
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        if (!this.mForcedNavigationBarColor) {
            this.mPhoneWindowExt.hookGenerateLayout(this, a, context);
            ...
            if (layoutResource2 == 0 || (features & 256) != 0) {
                ...
                if (layoutResource3 != 0) {
                    ...
                    if (layoutResource4 != 0) {
                        ...
                        int layoutResource6 = features & 256;
    ...
    public void setNavigationBarColor(int color) {
        ...
        DecorView decorView = this.mDecor;
        if (decorView != null) {
            decorView.mDecorViewExt.updateColorNavigationGuardColor(color);
