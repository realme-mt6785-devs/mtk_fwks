...
public interface RILConstants {
    ...
    public static final int PREFERRED_NETWORK_MODE = ((Integer) Optional.of(TelephonyProperties.default_network()).filter(RILConstants$$ExternalSyntheticLambda1.INSTANCE).map(RILConstants$$ExternalSyntheticLambda0.INSTANCE).orElse(0)).intValue();
