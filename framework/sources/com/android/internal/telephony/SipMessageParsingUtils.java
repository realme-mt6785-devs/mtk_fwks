...
public class SipMessageParsingUtils {
    ...
    public static List<Pair<String, String>> parseHeaders(String headerString, boolean stopAtFirstMatch, String... matchingHeaderKeys) {
                ...
                if (headerKey != null) {
                    if (matchingHeaderKeys == null || matchingHeaderKeys.length == 0 || Arrays.stream(matchingHeaderKeys).anyMatch(new Predicate() { // from class: com.android.internal.telephony.SipMessageParsingUtils$$ExternalSyntheticLambda1
                        ...
                        public final boolean test(Object obj) {
                            ...
                            equalsIgnoreCase = ((String) obj).equalsIgnoreCase(headerKey);
                            return equalsIgnoreCase;
                        }
                    })) {
                        result.add(new Pair<>(headerKey, headerValueSegment.toString()));
                        if (stopAtFirstMatch) {
                            return result;
                        }
                    }
        ...
        if (headerKey != null && (matchingHeaderKeys == null || matchingHeaderKeys.length == 0 || Arrays.stream(matchingHeaderKeys).anyMatch(new Predicate() { // from class: com.android.internal.telephony.SipMessageParsingUtils$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean equalsIgnoreCase;
                equalsIgnoreCase = ((String) obj).equalsIgnoreCase(headerKey);
