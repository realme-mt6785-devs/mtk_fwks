...
public class SmsMessage extends SmsMessageBase {
    protected static final byte BEARER_DATA = 8;
    protected static final byte BEARER_REPLY_OPTION = 6;
    protected static final byte CAUSE_CODES = 7;
    protected static final byte DESTINATION_ADDRESS = 4;
    protected static final byte DESTINATION_SUB_ADDRESS = 5;
    private static final String LOGGABLE_TAG = "CDMA:SMS";
    static final String LOG_TAG = "SmsMessage";
    protected static final byte ORIGINATING_ADDRESS = 2;
    protected static final byte ORIGINATING_SUB_ADDRESS = 3;
    ...
    protected static final byte SERVICE_CATEGORY = 1;
    protected static final byte TELESERVICE_IDENTIFIER = 0;
    ...
    protected void decodeSmsDisplayAddress(SmsAddress addr) {
