...
public class ImageUtils {
    ...
    public static Bitmap loadThumbnail(ContentResolver resolver, final Uri uri, final Size size) throws IOException {
        ...
        try {
            ...
            Bitmap decodeBitmap = ImageDecoder.decodeBitmap(ImageDecoder.createSource(new Callable() { // from class: com.android.internal.util.ImageUtils$$ExternalSyntheticLambda1
            ...
            }), new ImageDecoder.OnHeaderDecodedListener() { // from class: com.android.internal.util.ImageUtils$$ExternalSyntheticLambda0
