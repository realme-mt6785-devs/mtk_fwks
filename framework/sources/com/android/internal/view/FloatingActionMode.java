...
import android.app.WindowConfigurationExtPlugin;
...
public final class FloatingActionMode extends ActionMode {
    ...
    private boolean isContentRectWithinBounds() {
        ...
        if (WindowConfigurationExtPlugin.siSWindowingComactMode.call(Integer.valueOf(this.mContext.getResources().getConfiguration().windowConfiguration.getWindowingMode())).booleanValue()) {
            DisplayInfo outDisplayInfo = new DisplayInfo();
            this.mContext.getDisplayNoVerify().getDisplayInfo(outDisplayInfo);
            this.mScreenRect.set(0, 0, outDisplayInfo.logicalWidth, outDisplayInfo.logicalHeight);
        }
