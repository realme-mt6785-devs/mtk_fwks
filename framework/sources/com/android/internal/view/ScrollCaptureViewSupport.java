    ...
    public static int computeScrollAmount(Rect parentVisibleBounds, Rect requested) {
        ...
        if (requested.bottom <= bottom || requested.top <= top) {
            ...
            if (requested.height() > height) {
                int scrollYDelta = 0 - (bottom - requested.bottom);
                return scrollYDelta;
            }
            int scrollYDelta2 = 0 - (top - requested.top);
            return scrollYDelta2;
        } else if (requested.height() > height) {
            int scrollYDelta3 = 0 + (requested.top - top);
            return scrollYDelta3;
        } else {
            int scrollYDelta4 = 0 + (requested.bottom - bottom);
