...
public class CallLayout extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mIcon.setOnForceHiddenChangedListener(new Consumer() { // from class: com.android.internal.widget.CallLayout$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                CallLayout.this.lambda$onFinishInflate$0$CallLayout((Boolean) obj);
            }
        });
    }

    public /* synthetic */ void lambda$onFinishInflate$0$CallLayout(Boolean forceHidden) {
    ...
    public void setData(Bundle extras) {
        setUser((Person) extras.getParcelable(Notification.EXTRA_CALL_PERSON));
        updateCallLayout();
    }
