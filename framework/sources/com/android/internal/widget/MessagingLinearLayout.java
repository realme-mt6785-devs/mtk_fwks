    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (newHeight >= 0 && totalHeight2 < targetHeight) {
            if (getChildAt(newHeight).getVisibility() == 8) {
                ...
                int spacing3 = first ? 0 : spacing2;
                measureChildWithMargins(child, widthMeasureSpec, 0, heightMeasureSpec, ((totalHeight2 - this.mPaddingTop) - this.mPaddingBottom) + spacing3);
                int childHeight = child.getMeasuredHeight();
                int newHeight2 = Math.max(totalHeight2, totalHeight2 + childHeight + lp.topMargin + lp.bottomMargin + spacing3 + previousChildIncrease);
                ...
                if (showView) {
                    if (messagingChild2 != null) {
                        ...
                        previousTotalHeight = totalHeight2;
                    }
                    totalHeight2 = newHeight2;
