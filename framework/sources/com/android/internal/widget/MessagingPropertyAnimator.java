...
public class MessagingPropertyAnimator implements View.OnLayoutChangeListener {
    ...
    private static final int TAG_ALPHA_ANIMATOR = 16909520;
    private static final int TAG_FIRST_LAYOUT = 16909521;
    private static final int TAG_LAYOUT_TOP = 16909523;
    private static final int TAG_TOP = 16909527;
    private static final int TAG_TOP_ANIMATOR = 16909526;
    ...
    private static boolean isFirstLayout(View view) {
        Boolean tag = (Boolean) view.getTag(16909521);
        if (tag == null) {
            return true;
        }
    ...
    private static void setFirstLayout(View view, boolean first) {
        view.setTagInternal(16909521, Boolean.valueOf(first));
    }

    private static void setLayoutTop(View view, int top) {
        view.setTagInternal(16909523, Integer.valueOf(top));
    }

    public static int getLayoutTop(View view) {
        Integer tag = (Integer) view.getTag(16909523);
        if (tag == null) {
            return getTop(view);
        }
        return tag.intValue();
    ...
    public static int getTop(View v) {
        Integer tag = (Integer) v.getTag(16909527);
        if (tag == null) {
            return v.getTop();
        }
        return tag.intValue();
    ...
    public static void setTop(View v, int value) {
        v.setTagInternal(16909527, Integer.valueOf(value));
    ...
    private static void startTopAnimation(final View v, int start, int end, Interpolator interpolator) {
        ObjectAnimator existing = (ObjectAnimator) v.getTag(16909526);
        if (existing != null) {
            existing.cancel();
        }
        ...
        animator.addListener(new AnimatorListenerAdapter() { // from class: com.android.internal.widget.MessagingPropertyAnimator.2
            ...
            public void onAnimationEnd(Animator animation) {
                View.this.setTagInternal(16909526, null);
        ...
        v.setTagInternal(16909526, animator);
        animator.start();
    }
    ...
    public static void fadeIn(final View v) {
        ObjectAnimator existing = (ObjectAnimator) v.getTag(16909520);
        if (existing != null) {
            existing.cancel();
        }
    ...
    public static void fadeOut(final View view, final Runnable endAction) {
        ObjectAnimator existing = (ObjectAnimator) view.getTag(16909520);
        if (existing != null) {
            existing.cancel();
        }
        ...
        view.setTagInternal(16909520, animator);
        animator.start();
    }
    ...
    public static boolean isAnimatingTranslation(View v) {
        return v.getTag(16909526) != null;
    }

    public static boolean isAnimatingAlpha(View v) {
        return v.getTag(16909520) != null;
    }
