...
public class ViewPager extends ViewGroup {
            ...
            if (i < count2) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (lp.isDecor) {
                        ...
                        int paddingLeft3 = childLeft3 + child.getMeasuredWidth();
                        int paddingTop2 = childTop + child.getMeasuredHeight();
                        child.layout(childLeft3, childTop, paddingLeft3, paddingTop2);
                        decorCount++;
                    ...
                    if (child2.getVisibility() == i2) {
                        ...
                        if (lp2.isDecor) {
                            ...
                            if (ii == null) {
                                ...
                                paddingLeft = paddingLeft2;
                                int paddingLeft4 = paddingTop + child2.getMeasuredHeight();
                                child2.layout(childLeft, paddingTop, childLeft + childMeasuredWidth, paddingLeft4);
                            }
                        }
                    }
                    i4++;
        ...
        switch (action) {
            case 0:
                ...
                if (this.mScrollState != 2 || Math.abs(this.mScroller.getFinalX() - this.mScroller.getCurrX()) <= this.mCloseEnough) {
                    if (this.mLeftEdge.getDistance() != 0.0f || this.mRightEdge.getDistance() != 0.0f) {
    ...
    private boolean performDrag(float x, float y) {
        ...
        boolean needsInvalidate3 = isLayoutRtl();
        if (needsInvalidate3) {
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (pos < lastPos) {
                ...
                if (isLayoutRtl()) {
                    ...
                    left = (width * widthFactor) + scaledOffset;
                }
                float offset3 = itemOffset + widthFactor + marginOffset;
                int i = this.mPageMargin;
                float marginOffset2 = i;
                if (marginOffset2 + left > scrollX) {
                    ii = ii2;
                    offset = offset3;
