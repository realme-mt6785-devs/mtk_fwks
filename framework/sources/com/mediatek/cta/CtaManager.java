...
public class CtaManager {
    ...
    public void linkCtaPermissions(ParsingPackage pkg) {
    }
    ...
    public boolean isPermissionReviewRequired(String pkgName, String sharedUserId, List<String> requestedPermissions, int userId, boolean reviewRequiredByCache) {
        return false;
    }
    ...
    public void showPermErrorDialog(Context context, String processName, String pkgName) {
    }

    public boolean needShowMtkPermDialog(Context context, int uid, String pkgName, String exceptionMsg) {
        return false;
    }
    ...
    public AppOpsManager.RestrictionBypass opAllowSystemBypassRestriction(int op) {
        return null;
    }
