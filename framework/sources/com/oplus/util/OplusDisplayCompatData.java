...
public final class OplusDisplayCompatData implements Parcelable {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeByte(this.mEnableDisplayCompat ? (byte) 1 : (byte) 0);
        out.writeByte(this.mHasHeteromorphismFeature ? (byte) 1 : (byte) 0);
        out.writeByte(this.mRusImmersiveDefault ? (byte) 1 : (byte) 0);
