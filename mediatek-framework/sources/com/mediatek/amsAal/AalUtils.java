...
public final class AalUtils {
    ...
    static {
        boolean z = false;
        boolean equals = SystemProperties.get("ro.vendor.mtk_aal_support").equals("1");
        sIsAalSupported = equals;
        if (equals && SystemProperties.get("persist.vendor.sys.mtk_app_aal_support").equals("1")) {
            z = true;
        }
        sEnabled = z;
        sInstance = null;
    ...
    public synchronized void setSmartBacklightInternal(ComponentName name, int mode) {
        if (!sEnabled) {
            ...
            if (this.mCurrentConfig == null) {
                ...
                this.mCurrentConfig = new AalConfig(null, 128);
            }
    ...
    public synchronized void setDefaultSmartBacklightInternal(String reason) {
        ...
        if (!(aalConfig == null || aalConfig.mLevel == 128)) {
            Slog.d(TAG, "setSmartBacklightStrength(128) " + reason);
            this.mCurrentConfig.mLevel = 128;
            this.mCurrentConfig.mName = null;
            setSmartBacklightStrength(128);
        }
    }
