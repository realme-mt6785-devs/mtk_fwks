...
public class PowerHalWrapper {
    ...
    public static native int nativeNotifySbeRescue(int i, int i2, int i3);
    ...
    public void mtkNotifySbeRescue(int tid, int start, int enhance) {
        nativeNotifySbeRescue(tid, start, enhance);
    }
    ...
    public boolean getRildCap(int uid) {
        return nativeQuerySysInfo(40, uid) == 1;
    }
