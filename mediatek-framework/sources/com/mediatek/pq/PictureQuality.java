...
public class PictureQuality {
    ...
    private static native void nativeOplusSetColorMode(int i, int i2);
    ...
    public static String oplusSetMode(int mode) {
        nativeOplusSetColorMode(mode, 6);
        return null;
    }
    ...
    public static boolean setRGBGain(double r_gain, double g_gain, double b_gain, int step) {
        int r_gain_normalize = (int) (r_gain * 1024.0d);
        int g_gain_normalize = (int) (g_gain * 1024.0d);
        int b_gain_normalize = (int) (1024.0d * b_gain);
        return nativeSetRGBGain(r_gain_normalize, g_gain_normalize, b_gain_normalize, step);
    }

    public static double[] getRGBGain() {
        double[] arr = new double[3];
        int[] arr_int = {BluetoothMcsService.ObjectIds.CURRENT_TRACK_OBJ_ID, BluetoothMcsService.ObjectIds.CURRENT_TRACK_OBJ_ID, BluetoothMcsService.ObjectIds.CURRENT_TRACK_OBJ_ID};
        int[] arr_int2 = nativeGetRGBGain();
        if (arr_int2 == null) {
            Log.e("PQ", "getRGBGain() return null arr");
            return null;
        }
        arr[0] = arr_int2[0] / 1024.0d;
        arr[1] = arr_int2[1] / 1024.0d;
        arr[2] = arr_int2[2] / 1024.0d;
        return arr;
    }
    ...
    public static boolean setCcorrMatrix(double[] matrix, int step) {
        ...
        if (matrix == null) {
            Log.e("PQ", "setCcorrMatrix() matrix is null");
            return false;
        } else if (matrix == null || matrix.length == 9) {
