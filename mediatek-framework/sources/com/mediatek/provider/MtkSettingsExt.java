...
public final class MtkSettingsExt {
    ...
    public static final class System {
        ...
        public static final String VOICE_TRAINING_RETRAIN_CALLBACK_STATUS = "voice_training_retrain_callback_status";
        public static final String VOICE_WAKEUP_MANAGER_COMMAND_STATUS_UPDATE = "voice_wakeup_manager_command_status_update";
        ...
        public static String VOICE_WAKEUP_COMMAND_STATUS_UPDATE = "voice_wakeup_command_status_update";
        public static String VOICE_WAKEUP_COMMAND_UI_ACTION_1ENK = "voice_wakeup_command_ui_action_1enk";
        ...
        public static String SWITCH_RESOLUTION_BY_MODE = "switch_resolution_by_mode";
        ...
        public static void putInPublicSettings(Set<String> PUBLIC_SETTINGS) {
            ...
            PUBLIC_SETTINGS.add(VOICE_WAKEUP_COMMAND_STATUS_UPDATE);
            PUBLIC_SETTINGS.add(VOICE_WAKEUP_COMMAND_UI_ACTION_1ENK);
            ...
            PUBLIC_SETTINGS.add(VOICE_WAKEUP_MANAGER_COMMAND_STATUS_UPDATE);
            PUBLIC_SETTINGS.add(SWITCH_RESOLUTION_BY_MODE);
            PUBLIC_SETTINGS.add(VOICE_TRAINING_RETRAIN_CALLBACK_STATUS);
        }
    ...
    public static final class Global {
        ...
        public static final String DSDA_ENABLED = "dsda_enabled";
        ...
        public static final String SHOW_AMPLIFIER_OVERHEAT_WARNING = "show_amplifier_overheat_warning";
